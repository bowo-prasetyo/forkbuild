...
// the identical role `ui/components/reconciliation/CandidateEvidenceDetailPanel.js` (0.8.182)
...
// DISCIPLINE `ui/components/reconciliation/CandidateLeaderboardTable.js` ALREADY HOLDS.
...
// `ui/components/reconciliation/CandidateLeaderboardTable.js`. Summary counts render
...
// `ui/components/reconciliation/CandidateLeaderboardTable.js` tolerates a malformed
...
// candidateLabel() — duplicated from `ui/components/reconciliation/CandidateLeaderboardTable.js`'s
