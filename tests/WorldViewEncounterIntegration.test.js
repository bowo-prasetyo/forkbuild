...
async function run() {
    ...
    // ---------------------------------------------------------------
    {
        ...
        // 0.9.99/0.9.104/0.9.138/0.9.291 note: the tag itself grew further
        // already-existing WorldEncounterCanvas props (materialSources/
        // materialVerifier — see
        ...
        // snapshotDistributionCommand — see
        // tests/WorldViewSnapshotDistribution.test.js — and, 0.9.291,
        // getPublicationCommentariesCommand/addPublicationCommentaryCommand/
        // viewerIdentityId, the SAME commands/fact already bound to
