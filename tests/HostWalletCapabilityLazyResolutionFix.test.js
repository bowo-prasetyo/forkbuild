...
async function run() {
    ...
    // ===============================================================
    {
        ...
        assert(/nostrSnapshotDiscoveryPublisherOptions: \{ publishImpl: nostrHostPublisher, discoveryTag: 'forkbuild-snapshot', relayUrls: resolvedNostrRelayUrls \}/.test(mainSource), n('D3. the Snapshot distribution nostrSnapshotDiscoveryPublisherOptions call site still uses the SAME lazily-resolving nostrHostPublisher this fix relies on — now also carrying relayUrls, a later, unrelated relay-resilience addition'));
