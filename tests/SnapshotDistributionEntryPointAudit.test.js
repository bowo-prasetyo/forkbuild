...
async function run() {
    ...
    // ===============================================================
    {
        ...
        assert(constructions['new ArweaveContentStore('].sort().join(',') === 'application/SnapshotDistributionRuntimeComposition.js',
            `H1. 'new ArweaveContentStore(' appears in exactly one production file — found in: ${constructions['new ArweaveContentStore('].join(', ') || '(none)'}`);
