...
async function run() {
    ...
    // ---------------------------------------------------------------
    {
        ...
        const moduleSource = await fs.readFile(new URL('../application/claimSnapshotReconciliation/PlanIdentity.js', import.meta.url), 'utf8');
        ...
        const module = await import('../application/claimSnapshotReconciliation/PlanIdentity.js');
