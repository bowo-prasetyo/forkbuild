...
async function run() {
    ...
    // ---------------------------------------------------------------
    {
        ...
        const importLines = source.split('\n').filter((line) => line.trim().startsWith('import '));
        assert(importLines.length === 15, '37. WorldEncounterCanvas.js has exactly fifteen imports as of 0.9.182');
        ...
        assert(applicationImportLines.length === 13, '40. WorldEncounterCanvas.js imports exactly thirteen application/ modules as of 0.9.182');
