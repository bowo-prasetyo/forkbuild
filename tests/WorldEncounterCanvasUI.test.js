...
// that addition.
//
// 0.9.184 note: WorldEncounterCanvas.js gained `comparisonMaterialInspection`/
// `comparisonMaterialInspectionRequestId`/`contentComparisonViewOpen`
// page-local state, three new computeds (`comparisonEncounterSnapshotInspection`,
// `comparisonSnapshotContentView`, `worldSnapshotContentComparisonView`),
// three new methods (`refreshComparisonMaterialInspection()`/
// `openContentComparisonView()`/`closeContentComparisonView()`), and one new
// application/ import — see Section J, updated again below. Viewing both
// sides' own Content Views alongside the comparison fact is covered
