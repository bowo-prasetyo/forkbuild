...
async function run() {
    ...
    // ---------------------------------------------------------------
    {
        ...
        const importLines = source.split('\n').filter((line) => line.trim().startsWith('import '));
        assert(importLines.length === 12, '37. WorldEncounterCanvas.js has exactly twelve imports as of 0.9.177');
        ...
        assert(applicationImportLines.length === 10, '40. WorldEncounterCanvas.js imports exactly ten application/ modules as of 0.9.177');
