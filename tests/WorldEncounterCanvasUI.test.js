...
async function run() {
    ...
    // ---------------------------------------------------------------
    {
        ...
        const importLines = source.split('\n').filter((line) => line.trim().startsWith('import '));
        assert(importLines.length === 13, '37. WorldEncounterCanvas.js has exactly thirteen imports as of 0.9.179');
        ...
        assert(applicationImportLines.length === 11, '40. WorldEncounterCanvas.js imports exactly eleven application/ modules as of 0.9.179');
