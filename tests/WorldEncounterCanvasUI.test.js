...
async function run() {
    ...
    // ---------------------------------------------------------------
    {
        ...
        const importLines = source.split('\n').filter((line) => line.trim().startsWith('import '));
        assert(importLines.length === 11, '37. WorldEncounterCanvas.js has exactly eleven imports as of 0.9.176');
        ...
        assert(applicationImportLines.length === 9, '40. WorldEncounterCanvas.js imports exactly nine application/ modules as of 0.9.176');
