...
`);
    ...
    // =======================================================================
    {
        ...
        assert(/new IpfsContentStore\(\)/.test(await readSource('ui/main.js')) && /new IpfsGatewayContentStore\(\{ gatewayUrl: resolvedIpfsGatewayUrl \}\)/.test(await readSource('ui/main.js')),
            '1. Snapshot Placement\'s own "ipfs" storage type is backed by content/IpfsContentStore.js (Kubo — a locally-run IPFS daemon the person must have installed), confirmed in ui/main.js\'s own composition. (AMENDED 0.9.665 — the gateway construction now carries a resolved, settings-backed gatewayUrl; see docs/Roadmap.md.)');
