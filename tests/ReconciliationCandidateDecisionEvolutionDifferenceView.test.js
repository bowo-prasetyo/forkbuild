...
} from '../application/claimSnapshotReconciliation/candidate/DecisionEvolutionDifferenceView.js';
...
async function run() {
    ...
    // ---------------------------------------------------------------
    {
        ...
        const moduleSource = await (await import('node:fs/promises')).readFile(new URL('../application/claimSnapshotReconciliation/candidate/DecisionEvolutionDifferenceView.js', import.meta.url), 'utf8');
        ...
        assert(importBlock.includes('../decision/HistoryDifference.js'), '80. one import is 0.8.149\'s own decision history difference module');
        assert(importBlock.includes('./DecisionEvolutionView.js'), '81. the other import is 0.8.154\'s own candidate decision evolution module');
