...
import { describePublisherLeaderboardClaimSnapshotReconciliationDecisionHistoryRevalidation } from '../application/claimSnapshotReconciliation/decision/HistoryRevalidationView.js';
...
async function run() {
    ...
    // ---------------------------------------------------------------
    {
        ...
        const moduleSource = await fs.readFile(new URL('../application/claimSnapshotReconciliation/decision/HistoryRevalidationView.js', import.meta.url), 'utf8');
        ...
        const revalidationModule = await import('../application/claimSnapshotReconciliation/decision/HistoryRevalidationView.js');
...
run().catch((error) => {
    console.error('ReconciliationDecisionHistoryRevalidationView.test.js FAILED:', error);
    process.exitCode = 1;
});
