...
async function runTests() {
    ...
    // ---------------------------------------------------------------
    {
        ...
        assert(applicationImportLines.length === 9,
            '23. WorldEncounterCanvas.js still imports exactly nine application/ modules — discoveryCommand is a plain injected function, never a new algorithm import; the seventh is 0.9.112\'s own PublicationMaterialProvenance.js, the eighth 0.9.144\'s own SnapshotPublicationAttribution.js, the ninth 0.9.176\'s own WorldEncounterPresentation.js');
