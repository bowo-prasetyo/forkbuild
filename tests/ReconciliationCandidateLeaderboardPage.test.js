...
async function run() {
    ...
    // ---------------------------------------------------------------
    {
        ...
        const directPage = (await import('../application/claimSnapshotReconciliation/leaderboard/LeaderboardView.js'))
    ...
    // ---------------------------------------------------------------
    {
        const moduleSource = await (await import('node:fs/promises')).readFile(new URL('../application/claimSnapshotReconciliation/leaderboard/LeaderboardPage.js', import.meta.url), 'utf8');
        ...
        assert(importBlock.includes('./LeaderboardReadModel.js'), '49. one import is 0.8.177\'s own leaderboard read model');
        assert(importBlock.includes('./LeaderboardView.js'), '50. the other import is 0.8.178\'s own leaderboard page view');
