...
async function run() {
    ...
    // ---------------------------------------------------------------
    {
        ...
        const moduleSource = await (await import('node:fs/promises')).readFile(new URL('../application/claimSnapshotReconciliation/candidate/DecisionRevalidationObservationEvolutionAgreementView.js', import.meta.url), 'utf8');
        ...
        assert(importBlock.includes('../revalidationObservation/HistoryView.js'), '81. one import is 0.8.167\'s own archive-reading seam');
