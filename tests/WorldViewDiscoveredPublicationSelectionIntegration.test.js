...
async function runTests() {
    ...
    // ---------------------------------------------------------------
    {
        ...
        assert(applicationImportLines.length === 11,
            '21. WorldEncounterCanvas.js still imports exactly eleven application/ modules as of 0.9.179 — 0.9.113 introduced no new application-layer command, per its own "no application-layer command" restraint; the eighth is 0.9.144\'s own SnapshotPublicationAttribution.js, the ninth 0.9.176\'s own WorldEncounterPresentation.js, the tenth 0.9.177\'s own WorldSnapshotInspection.js, the eleventh 0.9.179\'s own MaterializedSnapshotWorldDiscoveryBridge.js (unregisterMaterializedSnapshotWorldSource() alone)');
