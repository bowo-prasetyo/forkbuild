...
async function run() {
    ...
    // ===============================================================
    {
        ...
        assert(/router-link to="\/settings\/stun"/.test(networkSettingsSource), '13b. the Network Settings hub links to the settings entry point — reachable one hop further, not a URL-only capability');
