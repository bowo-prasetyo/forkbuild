...
import { describePublisherLeaderboardClaimSnapshotReconciliationCandidate } from '../application/claimSnapshotReconciliation/ReconciliationCandidate.js';
...
async function run() {
    ...
    // ---------------------------------------------------------------
    {
        const moduleSource = await (await import('node:fs/promises')).readFile(new URL('../application/claimSnapshotReconciliation/ReconciliationCandidate.js', import.meta.url), 'utf8');
