...
async function run() {
    ...
    // ---------------------------------------------------------------
    {
        ...
        const moduleSource = await fs.readFile(new URL('../application/claimSnapshotReconciliation/decision/HistoryRevalidationDifferenceView.js', import.meta.url), 'utf8');
        ...
        assert(
            importLines.some((line) => line.includes('./HistoryDifference.js')),
        ...
        const module = await import('../application/claimSnapshotReconciliation/decision/HistoryRevalidationDifferenceView.js');
