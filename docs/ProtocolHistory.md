...
This file keeps the protocol notes that were written milestone by
milestone, from 0.1.x through 0.2.45, as they were written. Many of these
sections record that a milestone did NOT change the protocol. It is a
record, not the current specification: for the formats in use now, read
docs/Protocol.md. For why each change was made, read docs/Roadmap.md.
