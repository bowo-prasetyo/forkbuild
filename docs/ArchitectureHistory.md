...
This file keeps the architecture notes that were written milestone by
milestone, from 0.1.x through 0.3.4, as they were written. It is a
record, not a description of the current system: later milestones
changed or removed parts of what it describes. For how ForkBuild works
now, read docs/Architecture.md. For why each change was made, read
docs/Roadmap.md.

Don't update this file to match the code. Correct it only when it is
wrong about what was true at the time.
...
Since 0.5.9 World View no longer edits bricks. Every passage below that
