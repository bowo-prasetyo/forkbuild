// Synchronous SHA-256. crypto.subtle.digest() is Promise-only, and the
// fingerprint and identity functions that use this are synchronous
// describeXxx() calls, as is Bitcoin sighash/txid computation.
