...
// composition root ever builds it, application/world/CreateWorldViewUseCase.js,
...
// `Create*UseCase` factory (see application/discovery/CreateDiscoveryUseCase.js's
...
// here exactly the way application/world/CreateWorldViewUseCase.js's own
...
// application/discovery/CreateDiscoveryUseCase.js's own (used by
// ui/components/PublicationCatalog.js, independent of
// application/world/CreateWorldViewUseCase.js's own instance) — both read/write
...
export class CreatePublicationCommentaryUseCase {
    execute(identityProvider) {
        ...
        // application/world/CreateWorldViewUseCase.js's own 0.9.285 header. Every
