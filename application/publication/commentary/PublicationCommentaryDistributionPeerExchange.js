...
//
// application/anchoring/PublicationAnchorPeerExchange.js's own shape, applied to a
...
// NOT call: it never consults application/publication/CanCommentOnPublicationUseCase.js
...
export class PublicationCommentaryDistributionPeerExchange {
    ...
    // restraint application/anchoring/PublicationAnchorPeerExchange.js#announce()
    ...
    // silently — exactly like application/anchoring/PublicationAnchorPeerExchange.js#
...
// connection — see application/anchoring/PublicationAnchorPeerExchange.js's own
// DEFAULT_PROTOCOL.
