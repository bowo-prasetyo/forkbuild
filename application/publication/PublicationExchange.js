...
//
// The generalization of application/placeNaming/PlaceNamingClaimExchange.js and
// application/blueprint/BlueprintAttributionExchange.js one layer up: those two
...
// envelope itself — into application/publication/LocalPublicationCatalog.js,
...
// application/publication/LocalPublicationCatalog.js directly.
//
// The three-step discipline named in this milestone's own design
// conversation, always in this order, never fewer:
//
//   1. validate  — application/publication/DecentralizedPublicationValidator.js (is
...
// calls application/publication/PublicationResolver.js, never checks whether the
// locator this envelope names is even reachable. Cataloging is not
// resolving: see application/publication/LocalPublicationCatalog.js's own header and
...
//
// Unlike application/blueprint/BlueprintAttributionExchange.js/application/
