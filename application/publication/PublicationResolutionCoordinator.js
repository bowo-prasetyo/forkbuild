...
import { PeerContentRetrievalCoordinator } from '../peer/PeerContentRetrievalCoordinator.js';
...
// calling TWO of them in sequence — application/publication/PublicationResolver.js#
...
// entry application/publication/LocalPublicationCatalog.js happens to hold. `peer`/
...
// application/peer/PeerContentRetrievalCoordinator.js this class builds
...
// no new application/publication/PublicationResolutionOutcome.js value — see
// application/peer/PeerContentRetrievalCoordinator.js's own header for why
...
// application/publication/LocalPublicationCatalog.js's own header already applies to
...
export class PublicationResolutionCoordinator {
    constructor(publicationResolver, peerContentExchange = null) {
        ...
        // fresh application/peer/PeerContentRetrievalCoordinator.js — never a
    ...
    // Runs application/publication/PublicationResolver.js#resolve() unchanged. If the
    ...
    // application/peer/PeerContentRetrievalCoordinator.js#retrieve() call,
    ...
    // application/publication/PublicationResolver.js#resolve() a SECOND time. That
