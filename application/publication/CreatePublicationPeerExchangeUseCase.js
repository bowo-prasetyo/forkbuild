...
//
// Wires application/publication/CreatePublicationCatalogUseCase.js's own catalog +
// exchange pair to a live PublicationPeerExchange, so ui/ never imports
// application/publication/PublicationExchange.js or application/
// LocalPublicationCatalog.js directly — the same composition-root shape
// application/publication/CreatePublicationCatalogUseCase.js and application/
...
// ui/main.js) that application/publication/PublicationPeerExchange.js's own header
// already documents as never owned by it — the identical one-level-of-
// indirection application/identity/CreateIdentityLifecyclePropagationUseCase.js
// already established for the same two collaborators, applied here to a
// third gossiped record type.
//
// Deliberately NOT wired into application/world/CreateWorldViewUseCase.js —
...
// modify" shape application/publication/commentary/PublicationCommentaryNotificationProducer.js
