...
// application/publication/PublicationResolver.js#resolve() requires a `kindPlugin`
// per call, and this codebase had exactly two at the time this class was
// built: application/blueprint/BlueprintAttributionPublicationKind.js and
// application/placeNaming/PlaceNamingClaimPublicationKind.js (0.9.333 adds a third —
...
// (application/blueprint/CreateBlueprintAttributionUseCase.js, application/
...
// contract (application/publication/PublicationResolver.js never calls it — it only
...
// never had one — see application/publication/PublicationContentKind.js's own
...
// string, exactly the shape application/publication/PublicationResolver.js#resolve()
// already expects a caller to select from for whichever contentKind a
// cataloged application/publication/LocalPublicationCatalog.js entry actually
...
// caller — see application/publication/PublicationResolutionView.js's own
