...
import { NostrPublicationDiscoveryPublisher } from '../../nostr/NostrPublicationDiscoveryPublisher.js';
import { ArweaveAnnouncementPublisher } from '../../arweave/ArweaveAnnouncementPublisher.js';
...
// PROVIDER_GAP that audit named (`application/arweave/ArweaveAnnouncementPublisher.js`)
...
//        │
//        ▼
//   application/publication/distribution/PublicationDistributionRuntimeComposition.js   ★ (THIS)
...
// explicitly, exactly as `application/settings/RoleAwareProviderResolver.js`'s own
...
// delegated to `application/publication/distribution/PublicationMaterialUploaderComposition.js`'s own
