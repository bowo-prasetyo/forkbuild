...
// inspection already uses (see `application/worldEncounter/DiscoverWorldEncounterPublicationCommand.js`'s
...
// `application/worldEncounter/DecentralizedWorldEncounterMaterialDiscoveryRuntimeComposition.js`'s
