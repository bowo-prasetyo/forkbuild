...
// result comes from calling application/publication/observationArchive/PublicationObservationArchiveView.js's
...
// application/anchoring/bitcoin/BitcoinAnchorObservationArchiveView.js's own header already
// holds (anchorId, never contentHash or txid) — extended here to also
// include application/anchoring/bitcoin/BitcoinAnchorPublicationRecord.js's own identity
// records (which that 0.8.79 file predates), Base's own
// `baseTransactionInclusionObservationsByTransactionHash` keys (0.8.97),
// and application/anchoring/base/BaseAnchorPublicationRecord.js's own identity records
...
// the one count application/publication/observationArchive/PublicationObservationArchive.js's own
...
// application/anchoring/base/BaseAnchorPublicationRecord.js's own header, "No `anchorId`
// field").
