...
// archive instance is application/publication/observationArchive/PublicationObservationArchiveInspection.js's
...
export function describePublicationObservationArchiveDifference(currentArchive, externalArchive) {
    ...
    const publicationReferenceRecords = diffPositionalCollection(
