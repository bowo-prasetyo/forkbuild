...
// shape application/publication/commentary/PublicationCommentaryNotificationProducer.js already
// established one domain over: rather than adding connection-sync
// behavior into application/publication/PublicationPeerExchange.js's own onChange
...
// button already calls it. application/publication/PublicationPeerExchange.js is
...
// DecentralizedPublication envelope application/publication/PublicationExchange.js
// already knows how to carry — see that file's own header, and
// application/publication/PublicationPeerExchange.js's own header, for why actual
// document/material bytes stay entirely outside this seam. This class
// never imports application/publication/PublicationResolver.js, any ContentStore, or
// application/peer/PeerContentExchange.js, and none should ever be added to
// it.
//
...
// application/publication/LocalPublicationCatalog.js#add()'s own first-seen-wins
...
export class PublicationPeerConnectionSync {
    ...
    dispose() {
        ...
        // application/publication/PublicationPeerExchange.js#dispose() already
