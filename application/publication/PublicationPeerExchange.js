...
// built since (application/identity/IdentityLifecyclePropagationUseCase.js,
// application/identity/DeviceAuthorizationPropagationUseCase.js) is exactly this
...
// application/peer/ConnectedPeerRegistry.js peer (now and in the future, via
// its own onChange), subscribe to this file's own DEFAULT_PROTOCOL, and
// run every incoming ANNOUNCE through application/publication/PublicationExchange.js#
...
// application/publication/PublicationResolver.js, and never inspects the wrapped
...
// signed it" — exactly what application/publication/PublicationExchange.js#
...
// retrieved stays application/publication/PublicationResolver.js#resolve()'s own
...
// (checked entirely inside application/publication/PublicationExchange.js) is the only
...
export class PublicationPeerExchange {
    ...
    // way (application/publication/PublicationResolver.js#publish(), or a prior
    ...
    // without polling application/publication/LocalPublicationCatalog.js itself.
    ...
    // application/publication/PublicationExchange.js#importPublication() UNCHANGED —
    ...
    // application/identity/DeviceAuthorizationPropagationUseCase.js#_handleGrant()
