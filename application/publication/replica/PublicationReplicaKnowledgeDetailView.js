...
import { describeAnchorKnowledge } from '../../anchoring/PublicationAnchorKnowledgeView.js';
import { deriveAnchorVerificationLifecycle } from '../../anchoring/PublicationAnchorVerificationLifecycleView.js';
import { AnchorVerificationLifecycleState } from '../../anchoring/AnchorVerificationLifecycleState.js';
...
// first-seen, and application/anchoring/PublicationAnchorVerificationLifecycleView.js
...
// application/publication/PublicationDecentralizationView.js's OWN (0.8.27): this is
...
// argument, exactly like application/publication/replica/PublicationReplicaKnowledgeView.js's
...
// (application/anchoring/AnchorAcquisitionKind.js's own 0.8.17 rule, restated one
...
// application/anchoring/PublicationAnchorKnowledgeView.js's/application/
...
// split application/publication/PublicationDecentralizationView.js's own header
...
// first learned (application/anchoring/LocalAnchorKnowledgeStore.js's own
...
// — `knowledgeRecord` an application/anchoring/AnchorKnowledgeRecord.js instance (or
...
// were learned by each application/anchoring/AnchorAcquisitionKind.js/application/
