...
import { ImportPackageAnchorsUseCase } from '../../anchoring/ImportPackageAnchorsUseCase.js';
import { ImportPackageSnapshotPlacementsUseCase } from '../../snapshot/placement/ImportPackageSnapshotPlacementsUseCase.js';
...
//
//   pkg.publication  -> application/publication/PublicationExchange.js#importPublication()             (0.7.2)
//   pkg.anchors      -> application/anchoring/ImportPackageAnchorsUseCase.js (unchanged, 0.8.7)       -> PublicationAnchorExchange#importAnchor()
//   pkg.placements   -> application/snapshot/placement/ImportPackageSnapshotPlacementsUseCase.js (unchanged, 0.8.22) -> PublicationSnapshotPlacementExchange#importPlacement()
//
// A Publication Replica Package (application/publication/replica/PublicationReplicaPackage.js)
...
// for package import."
//
// Deliberately never calls application/anchoring/ExternalAnchorVerifier.js or
// application/snapshot/placement/SnapshotPlacementResolver.js, and never queries a network —
// see application/publication/replica/BuildPublicationReplicaPackageUseCase.js's own header
...
// their own — application/anchoring/AnchorAcquisitionKind.js#PACKAGE / application/
...
// distinguish (see application/publication/replica/PublicationReplicaKnowledgeView.js, 0.8.28,
...
export class ImportPublicationReplicaPackageUseCase {
    // publicationExchange: an application/publication/PublicationExchange.js instance.
    ...
    // application/anchoring/LocalAnchorKnowledgeStore.js/application/
    ...
    //   publicationIsNew    — see application/publication/LocalPublicationCatalog.js#
