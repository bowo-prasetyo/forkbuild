...
// `{ result }` — application/publication/evidence/PublicationEvidenceDiscoveryCoordinator.js#
...
export function describeEvidenceDiscoveryAttempt(attempt = null) {
    ...
    // application/publication/evidence/PublicationEvidenceDiscoveryUiState.js's own header on
