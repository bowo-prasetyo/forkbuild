...
// inside application/anchoring/PublicationAnchorPeerExchange.js; every placement
// crosses the identical placement-side boundary. A claim synchronize()
// newly catalogs is recorded application/anchoring/AnchorAcquisitionKind.js#PEER /
// application/placement/PlacementAcquisitionKind.js#PEER — never a new `SYNC`
...
// identical restraint application/publication/PublicationDecentralizationView.js
...
export class PublicationKnowledgeSynchronizationCoordinator {
    ...
    // concurrently (application/anchoring/PublicationAnchorDiscoveryCoordinator.js
    // and application/snapshot/placement/PublicationSnapshotPlacementDiscoveryCoordinator.js
    ...
    // application/publication/evidence/PublicationEvidenceDiscoveryCoordinator.js#discover()
