...
export class LocalPresenceStore {
    ...
    // conflicting, or stale — see application/presence/PresenceTrustBoundary.js
    ...
    // The "pull" half — a caller (application/presence/PresenceSyncService.js,
    ...
    list(now = Date.now()) {
        ...
        for (const [avatarId, record] of this._records) {
            ...
            result.push({
                ...
                // application/avatar/RemoteAvatarRegistry.js never reads it.
