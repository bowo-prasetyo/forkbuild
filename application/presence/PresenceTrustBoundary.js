...
// through before application/presence/LocalPresenceStore.js's Map is ever
...
// reason NEVER mutates application/presence/LocalPresenceStore.js's stored
...
export class PresenceTrustBoundary {
    ...
    // application/identity/FriendRelationshipUseCase.js's own `isBlocked`
    // contract exactly: called fresh every time, never cached, never
    // backed by this class importing application/peer/PeerBlockUseCase.js
    ...
    // currentAdvertisement: whatever application/presence/LocalPresenceStore.js
