...
// (typically the one `application/leaderboard/PublisherLeaderboardSnapshotClaimExchange.js#importPublisherLeaderboardSnapshotClaim()`
...
//
// `origin` REUSES `application/publication/observationArchive/PublicationObservationArchiveProvenance.js`
// (0.8.83) RATHER THAN INVENTING A SECOND PROVENANCE VOCABULARY. A claim
// this replica itself signed (via `application/leaderboard/CreatePublisherLeaderboardSnapshotClaimUseCase.js`)
// and chooses to keep alongside the ones it received is `LOCAL`; a claim
// that arrived through `application/leaderboard/PublisherLeaderboardSnapshotClaimExchange.js`'s
...
// `application/leaderboard/PublisherLeaderboardSnapshotClaimVerification.js`'s own
...
// REFUSAL `application/leaderboard/PublisherLeaderboardSnapshotClaimExchange.js#exportPublisherLeaderboardSnapshotClaim()`
...
// CODEBASE (`application/publication/PublicationReferenceRecord.js`,
// `application/publisher/PublisherPublicationAssociationRecord.js`). Every field is
...
export class LeaderboardClaimRecord {
    ...
    static fromJSON(json) {
        ...
        // unreachable in practice. application/publication/observationArchive/PublicationObservationArchive.js's
