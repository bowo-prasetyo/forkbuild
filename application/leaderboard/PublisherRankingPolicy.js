import { PublisherIdentityRecord } from '../publisher/PublisherIdentityRecord.js';
import { PublicationObservationArchive } from '../publication/observationArchive/PublicationObservationArchive.js';
import { reconstructDistinctPublisherIdentifiers } from '../publisher/PublisherAssociationView.js';
import { reconstructPublisherAchievementStatistics } from '../achievement/PublisherAchievementStatisticsView.js';
...
// fourteenth) collection on `application/publication/observationArchive/PublicationObservationArchive.js`,
...
// `application/publisher/PublisherAssociationView.js`'s own
...
// `application/achievement/PublisherAchievementStatisticsView.js`'s own
...
// count `application/achievement/PublisherAchievementStatisticsView.js` already
...
// `application/achievement/PublisherAchievementProfileView.js`'s own "first time seen,
...
// (`application/publisher/PublisherIdentityRecord.js`'s own header) — and asks
