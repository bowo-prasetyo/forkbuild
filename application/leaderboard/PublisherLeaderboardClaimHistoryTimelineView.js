...
// `application/leaderboard/LeaderboardClaimHistory.js`'s own append-only discipline)
...
// `application/leaderboard/LeaderboardClaimRecord.js`'s own header, "A Receipt, Never
