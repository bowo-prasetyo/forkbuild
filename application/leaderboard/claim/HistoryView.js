...
//
// The presentation counterpart of `application/leaderboard/claim/History.js`
// — mirroring `application/publication/PublicationReferenceRecordHistoryView.js`
...
// this layer — see `application/leaderboard/claim/Record.js`'s own header,
// "A Receipt, Never A Verdict." `application/leaderboard/snapshot/ClaimVerification.js`
...
// scored" restraint `application/publication/PublicationReferenceRecordHistoryView.js`'s
...
// network access, no read of `application/publication/observationArchive/PublicationObservationArchive.js`
...
// application/publication/observationArchive/PublicationObservationArchive.js's own `leaderboardClaimRecords`
...
// this family (`leaderboard/claim/HistoryDifference.js`,
// `leaderboard/claim/HistoryStatisticsView.js`,
// `leaderboard/claim/HistoryTimelineView.js`) already expects, so
...
// leaderboard/snapshot/Snapshot.js's own `reconstructPublisherLeaderboardSnapshot()`
