import { LeaderboardClaimRecord } from './Record.js';
import { appendLeaderboardClaimHistoryEntry } from './History.js';
import {
    PublisherLeaderboardSnapshotClaimImportOutcome,
    importPublisherLeaderboardSnapshotClaim
} from '../snapshot/ClaimExchange.js';
...
// wire shape (see `application/leaderboard/claim/Record.js`) — never a new
...
// DEPARTURE FROM `application/achievement/AchievementEvidenceMerge.js`'S OWN
...
// canonical string, mirroring `application/achievement/AchievementEvidenceMerge.js`'s
...
// them — mirroring `application/leaderboard/claim/History.js#appendLeaderboardClaimHistoryEntry()`'s
...
// `application/achievement/AchievementEvidenceExchange.js`'s own header already
...
// leaderboard/claim/HistoryView.js#describePublisherLeaderboardClaimHistory()`'s
...
// `leaderboard/claim/VerificationView.js`, and
// `leaderboard/claim/VerificationHistoryView.js` do not appear —
...
// `application/leaderboard/snapshot/ClaimExchange.js#exportPublisherLeaderboardSnapshotClaim()`
// and `application/leaderboard/claim/HistoryView.js#describePublisherLeaderboardClaimHistory()`
...
// `toJSON()` output, mirroring `application/achievement/AchievementEvidenceMerge.js`'s
