...
import { reconstructPublisherLeaderboardClaimHistory } from './HistoryView.js';
...
// `application/achievement/PublisherAchievementStatisticsView.js` (0.8.111), one
...
// leaderboard/claim/HistoryView.js`'s own header already draws that
...
// SORTED BY COUNT. Mirroring `application/achievement/PublisherAchievementStatisticsView.js`'s
...
// leaderboard/claim/HistoryDifference.js`'s own header, "Compares
// Stored Receipts, Never Verification Results," and `application/
// leaderboard/claim/HistoryExchange.js`'s own header, "This
...
// exactly as `application/leaderboard/claim/HistoryDifference.js`'s
...
// application/leaderboard/claim/HistoryView.js's own
...
// tolerance `application/achievement/PublisherAchievementStatisticsView.js`'s own
