...
// `application/achievement/AchievementEvidenceDifference.js` (0.8.117), one layer up:
...
// history is `application/leaderboard/claim/HistoryExchange.js`'s
...
// exact structural equality of a record's own complete `toJSON()` output.
// Word for word `application/leaderboard/claim/HistoryExchange.js`'s
