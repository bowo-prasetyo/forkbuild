...
// (typically the one `application/leaderboard/snapshot/ClaimExchange.js#importPublisherLeaderboardSnapshotClaim()`
...
// this replica itself signed (via `application/leaderboard/snapshot/CreateClaimUseCase.js`)
// and chooses to keep alongside the ones it received is `LOCAL`; a claim
// that arrived through `application/leaderboard/snapshot/ClaimExchange.js`'s
...
// `application/leaderboard/snapshot/ClaimVerification.js`'s own
...
// REFUSAL `application/leaderboard/snapshot/ClaimExchange.js#exportPublisherLeaderboardSnapshotClaim()`
