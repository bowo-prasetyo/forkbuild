...
// `leaderboard/snapshot/Fingerprint.js` answers a genuinely
...
// 0.8.121's own `leaderboard/snapshot/Fingerprint.js` has none: both
...
// imports nothing from `application/leaderboard/snapshot/Verification.js`,
