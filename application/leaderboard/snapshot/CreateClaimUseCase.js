...
import { reconstructPublisherLeaderboardSnapshot } from './Snapshot.js';
import { describePublisherLeaderboardSnapshotFingerprint } from './Fingerprint.js';
...
// (`application/placeNaming/PlaceNamingClaimUseCase.js#publish()`,
// `application/blueprint/BlueprintAttributionUseCase.js`,
...
// HOLDS. `application/leaderboard/snapshot/Snapshot.js` (0.8.119) and
// `application/leaderboard/snapshot/Verification.js` (0.8.120) are
...
// imports nothing from `application/publisher/PublisherIdentityRecord.js`. See
...
// `application/placeNaming/PlaceNamingClaimUseCase.js#publish()` ALREADY HOLDS. A
...
// anything, never touches `application/publication/observationArchive/PublicationObservationArchive.js`
