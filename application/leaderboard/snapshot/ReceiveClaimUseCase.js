import { importPublisherLeaderboardSnapshotClaim, PublisherLeaderboardSnapshotClaimImportOutcome } from './ClaimExchange.js';
import { LeaderboardClaimRecord } from '../claim/Record.js';
import { appendLeaderboardClaimHistoryEntry } from '../claim/History.js';
...
// never calls `application/leaderboard/snapshot/ClaimVerification.js#verifyPublisherLeaderboardSnapshotClaim()`,
// never reads or touches `application/publication/observationArchive/PublicationObservationArchive.js`,
...
// `application/publication/observationArchive/PublicationObservationArchive.js`'s OWN `.with...()`
...
// leaderboard/snapshot/CreateClaimUseCase.js`) side by side in the
