...
import { createArweaveTaggedTransactionUpload } from './ArweaveTaggedTransactionUpload.js';
import { createArweaveTaggedTransactionSearch } from './ArweaveTaggedTransactionSearch.js';
...
// composition of `application/ArweaveTaggedTransactionUpload.js` (write) and
...
// IDENTICAL RESTRAINT `application/PublicationCommentaryNostrDistribution.js`
...
// or `application/PublicationCommentaryDistributionExchange.js`. It treats
...
// as `application/DiscoverPublicationCommentaryFromArweaveUseCase.js` (this
...
// (`application/ArweaveTaggedTransactionSearch.js`, this same milestone)
...
// others" restraint `application/ArweaveGraphqlDiscoveryQueryService.js`'s
...
// path (`application/PublicationCommentaryDistributionPeerExchange.js`),
// all untouched; automatic fan-out to both Nostr and Arweave from one call
// (see `application/PublicationDistributionRuntimeComposition.js`'s own
...
// change to `application/ArweaveAnnouncementPublisher.js` or `application/
