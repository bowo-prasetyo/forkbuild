...
// (0.8.109, UNCHANGED — `application/achievement/PublisherAchievementProfileView.js`'s
...
// (0.8.110, UNCHANGED — `application/achievement/PublisherAchievementBadgeView.js`'s
...
// AWAY HERE. `application/achievement/AchievementBadgeView.js`'s own 0.8.103 scope
...
// `AchievementKind` (`application/achievement/AchievementEvent.js`) is an eleven-value
...
// `BlockchainKind` (`application/anchoring/BlockchainKind.js`) is a small, genuinely
