import { BlockchainKind } from '../anchoring/BlockchainKind.js';
...
// COLLECTION. `application/publication/observationArchive/PublicationObservationArchive.js` gains
...
// stamped with. `application/ipfs/IpfsPublicationRecord.js` carries no
...
// `application/anchoring/bitcoin/BitcoinAnchorPublicationRecord.js` nor `application/
...
// restraint `application/anchoring/BlockchainKind.js`'s own header already holds for
...
// application/publication/PublicationReferenceRecord.js (0.8.104) — the first
...
// milestone existed — `application/achievement/AchievementBadgeView.js`'s own
...
// shorthand key application/publication/PublicationReferenceGraphView.js's own
...
// RESTRAINT HELD ONE LAYER UP. `application/publication/observationArchive/PublicationObservationArchive.js`
...
// reason application/publication/PublicationReferenceGraphView.js's own `identityKey()`
...
// application/publication/observationArchive/PublicationObservationArchive.js already holds for a
