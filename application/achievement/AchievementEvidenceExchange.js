...
// explicit next step — grep this file and `application/achievement/AchievementEvent.js`,
...
// Must match `application/achievement/AchievementEvidenceExport.js`'s own
...
// two unrelated files" discipline `application/achievement/AchievementEvidenceDifference.js`'s
// own `canonicalRecordKey()` and `application/achievement/AchievementEvidenceFingerprint.js`'s
