import { BlockchainPublicationIdentity } from '../anchoring/BlockchainPublicationIdentity.js';
import { PublicationObservationArchive } from '../publication/observationArchive/PublicationObservationArchive.js';
import { describePublisherAssociatedPublications } from '../publisher/PublisherAssociationView.js';
...
// `application/publisher/PublisherAssociationView.js`'s own header already named as
...
// AchievementEvent.js` or `application/publisher/PublisherAssociationView.js` did not
...
// `application/achievement/AchievementProfileView.js`'s own restraint (0.8.107) one
...
// below calls `application/publisher/PublisherAssociationView.js`'s own
...
// — the identical `events` `application/achievement/AchievementEvent.js`'s own
...
// ACHIEVEMENT EVENTS ALONE. `application/publisher/PublisherPublicationAssociationRecord.js`'s
...
// shorthand key `application/achievement/AchievementEvent.js`'s own `referenceIdentityKey()`
...
// `application/publisher/PublisherAssociationView.js`'s own `describeDistinctPublisherIdentifiers()`
...
// `application/achievement/AchievementProfileView.js`'s OWN `describeAchievementProfile()`
...
// PER publication — see `application/achievement/AchievementEvent.js`'s own 0.8.106
...
// `AchievementKind` vocabulary (`application/achievement/AchievementEvent.js`) this
...
// archive — mirroring `application/achievement/AchievementProfileView.js`'s own
...
// reason `application/achievement/AchievementEvent.js`'s own `referenceIdentityKey()`
...
// `application/achievement/AchievementProfileView.js`'s own header already holds.
...
// entry point, mirroring `application/achievement/AchievementProfileView.js`'s own
