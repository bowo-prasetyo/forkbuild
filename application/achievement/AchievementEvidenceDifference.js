...
// application/publication/observationArchive/PublicationObservationArchiveDifference.js's own 0.8.87
...
// `application/anchoring/bitcoin/BitcoinAnchorPublicationRecord.js`'s own header, "never
...
// `application/achievement/AchievementEvidenceFingerprint.js`'s own SHA-256, versus
...
// reference (`application/anchoring/bitcoin/BitcoinAnchorPublicationRecord.js`'s and
// `application/anchoring/base/BaseAnchorPublicationRecord.js`'s own headers). This file
...
// archive is `application/achievement/AchievementEvidenceMerge.js`'s own, already-built
...
// this file imports none of `application/achievement/AchievementEvent.js`,
...
// identical fixed order, `application/achievement/AchievementEvidenceFingerprint.js`'s
...
// — word for word `application/achievement/AchievementEvidenceMerge.js`'s own
