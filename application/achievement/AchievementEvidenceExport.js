import {
    ...
    validateArray
} from '../publication/observationArchive/PublicationObservationArchive.js';
import { PublicationObservationArchiveProvenanceOrigin } from '../publication/observationArchive/PublicationObservationArchiveProvenance.js';
...
//
//   Durable evidence   (application/publication/observationArchive/PublicationObservationArchive.js)
//        │
//        ▼
//   Achievement events        (application/achievement/AchievementEvent.js,        0.8.102/0.8.106)
//        │
//        ▼
//   Achievement badges        (application/achievement/AchievementBadgeView.js,    0.8.103)
//        │
//        ▼
//   Publisher statistics      (application/achievement/PublisherAchievementStatisticsView.js, 0.8.111)
//        │
//        ▼
//   Ranking policy            (application/leaderboard/PublisherRankingPolicy.js,  0.8.112)
//        │
//        ▼
//   Leaderboard                (application/leaderboard/PublisherLeaderboardView.js, 0.8.113)
//
...
// application/publication/observationArchive/PublicationObservationArchive.js's own `fromJSON()` already
...
// `application/publication/observationArchive/PublicationObservationArchive.js` holds TEN factual
...
// pipeline actually reads. `application/achievement/AchievementEvent.js`'s own
// `reconstructAchievementEvents()` reads only the first three, verbatim,
// off the archive it is given; `application/publisher/PublisherAssociationView.js`'s
...
// unjustified copy of application/publication/observationArchive/PublicationObservationArchiveExport.js's
...
// application/publication/observationArchive/PublicationObservationArchiveExport.js'S OWN HEADER ALREADY
...
// THE IDENTICAL RESTRAINT application/publication/observationArchive/PublicationObservationArchiveExport.js's
