...
// and `application/ArweaveTaggedTransactionUpload.js` already expect for
...
//   above. `application/ArweaveAnnouncementPublisher.js` and `application/
...
// - **Any change to `application/ArweaveWorldEncounterMaterialResolver.js`
//   or `application/DecentralizedWorldEncounterMaterialSource.js`.** 0.9.493
//   Section E already proved both already do the right thing, unmodified,
//   the instant a candidate names the right location.
// - **Any change to `application/NostrDiscoveryQueryService.js`.** Nostr
...
// same private helper `application/NostrDiscoveryQueryService.js` already
