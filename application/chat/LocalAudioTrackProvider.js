...
// application/chat/VoiceUseCase.js exactly the way storage/StorageProvider.js
...
// actually being placed or accepted — see application/chat/VoiceUseCase.js's
...
export class LocalAudioTrackProvider {
    ...
    // it was unplugged since it was listed) — application/chat/VoiceUseCase.js
    ...
    // application/chat/VoiceUseCase.js#supportsVoice()'s own "answer honestly,
