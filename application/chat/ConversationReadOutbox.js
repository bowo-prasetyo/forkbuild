...
// durable per-owner store, alongside application/chat/ChatOutbox.js (0.2.63,
// messages not yet confirmed delivered), application/chat/ConversationStore.js
// (0.2.69, what we talked about), and application/chat/ConversationReadTracker.js
...
// codebase already uses — see application/chat/ChatOutbox.js's own header —
...
// application/chat/ChatOutbox.js: that store answers "what MESSAGE have I
...
// application/chat/ChatOutbox.js's own header established in 0.2.63 for the
// identical reason: a "reconnect" that genuinely authenticates as the
// WRONG identity finds no entry here addressed to it, so
// application/chat/ChatUseCase.js#_attemptFlush()'s own reconnect-triggered
...
export class ConversationReadOutbox {
    ...
    // application/chat/ChatOutbox.js#list applies to QUEUED/SENT versus
    ...
    // application/chat/ConversationReadTracker.js#markRead already
    ...
    // application/chat/ChatOutbox.js#cancel() adds to the message outbox,
    ...
    // application/chat/ChatUseCase.js's own local authorization for this
