...
// one (application/editor/StructurePlacementGestureService.js, 0.2.92's).
//
...
// once per render session in application/world/RenderWorldUseCase.js), but the
...
// whatever `application/editor/EditorSession.js` last gave it.
//
