...
// that class. `application/editor/EditorSession.js`'s own 0.2.91 header already
...
// structure. See `application/editor/GizmoGestureRouter.js` for how the
...
export class StructurePlacementGestureService {
    ...
    // `application/editor/EditorSession.js#_refreshGizmo()` can anchor the SAME
    ...
    // Mirrors application/editor/EditorSession.js#_structurePlacementFits() and
    ...
    _boundsForPlacement(placement) {
        ...
        // application/editor/StructureDocumentResolver.js's own header on what
