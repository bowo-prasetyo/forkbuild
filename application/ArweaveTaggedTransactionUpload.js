...
// Deliberately the same magnitude application/ArweavePublicationMaterialUploader.js's
...
// standing between `application/ArweaveAnnouncementPublisher.js` (0.9.428)
...
// 0.9.490 header) and `application/ArweavePublicationMaterialUploader.js`'s
...
//        │
//        ▼
//   application/ArweaveTaggedTransactionUpload.js   ★ (THIS)
...
// `application/ArweaveAnnouncementPublisher.js`'s own header). Neither file
...
//   `application/PublicationDistributionRuntimeComposition.js`, `application/
...
// non-empty strings — the same shape application/ArweaveAnnouncementPublisher.js
