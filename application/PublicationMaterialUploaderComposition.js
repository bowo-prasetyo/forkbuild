...
//
// `application/PublicationDistributionRuntimeComposition.js` (0.9.47/0.9.428)
...
// ANNOUNCEMENT goes (see `application/ContentStorePublicationMaterialUploader.js`'s
...
// - **Any change to `application/ArweavePublicationMaterialUploader.js`,
