...
// application/peer/PeerRelationshipUseCase.js: a `core/PeerRelationship.js`
...
export class FriendRelationshipUseCase {
    ...
    // application/peer/PeerBlockUseCase.js or core/PeerBlockRecord.js itself
    ...
    // name cross-references application/peer/PeerRelationshipUseCase.js's
    ...
    // real, currently AUTHENTICATED application/peer/ConnectedPeer.js — see
    ...
    // mirroring application/peer/PeerRelationshipUseCase.js#onRelationshipsChanged's
    // own shape exactly.
