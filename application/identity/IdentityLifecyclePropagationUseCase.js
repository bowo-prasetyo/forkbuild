...
// closes that gap the same way application/identity/FriendRelationshipUseCase.js
...
// itself succeeds — see application/identity/IdentityUseCase.js). It never
...
// gate — mirrors application/identity/FriendRelationshipUseCase.js's own
...
// store at all — see application/identity/CreateIdentityLifecyclePropagationUseCase.js
...
export class IdentityLifecyclePropagationUseCase {
    ...
    // unlike application/chat/ChatOutbox.js's own reliable-delivery model).
    ...
    //      direct opposite of application/identity/FriendRelationshipUseCase.js's
