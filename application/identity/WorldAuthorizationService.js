...
// WorldNavigationSession.js, application/editor/SpatialEditingService.js) and
...
// already consults (application/presence/PresenceTrustBoundary.js,
// application/avatar/AvatarProfileTrustBoundary.js,
// application/avatar/AvatarInteractionTrustBoundary.js,
// application/world/WorldNavigationSession.js's own `_isBlocked` —
// application/world/CreateWorldViewUseCase.js already derives it from
// application/peer/PeerBlockUseCase.js for those). Deliberately checked
...
// application/identity/WorldMembershipUseCase.js#hasActiveGrant() already
...
// about (application/world/WorldNavigationSession.js does, via its own
// `documentId`; application/document/WorldCommandPropagationUseCase.js does, via
...
export class WorldAuthorizationService {
    ...
    // application/identity/WorldMembershipUseCase.js consults before letting
    ...
    // freshness discipline application/identity/DeviceAuthorizationPropagationUseCase.js#
