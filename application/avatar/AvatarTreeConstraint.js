...
// mirroring exactly the split 0.2.42 (application/avatar/AvatarMovementConstraint.js,
// buildings) and 0.2.77 (application/avatar/AvatarTerrainConstraint.js, terrain
...
// application/avatar/AvatarMovementConstraint.js#apply() and
// application/avatar/AvatarTerrainConstraint.js#apply() already established for
...
export class AvatarTreeConstraint {
    ...
    // application/avatar/AvatarMovementController.js's own pipeline, where this
    ...
    // shape application/avatar/AvatarMovementConstraint.js#apply() already
    ...
    // application/avatar/AvatarMovementController.js supplies one — see that
