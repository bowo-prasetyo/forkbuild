...
// that remains application/avatar/AvatarTerrainConstraint.js's own, entirely
...
// application/avatar/AvatarTerrainConstraint.js already established: this
...
// pipeline application/avatar/AvatarMovementController.js runs each tick —
// see that class's own header for the full order and why it matters:
// building collision (application/avatar/AvatarMovementConstraint.js) decides
...
// (application/avatar/AvatarTerrainConstraint.js) decides whether the
...
// Bug fix — see application/avatar/AvatarMovementConstraint.js's own matching
...
export class AvatarStepConstraint {
    ...
    // application/avatar/AvatarMovementConstraint.js's own constructor header;
    ...
    // application/avatar/AvatarMovementController.js reads BEFORE simulating
    ...
    // instances — see application/avatar/AvatarMovementConstraint.js#
    ...
    //       the caller — application/avatar/AvatarMovementController.js — to
