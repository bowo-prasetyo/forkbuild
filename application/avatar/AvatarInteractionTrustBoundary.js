...
// application/presence/PresenceTrustBoundary.js/AvatarProfileTrustBoundary.js,
...
// STATE (see application/avatar/AvatarInteractionSyncService.js's own
// header):
//
...
// application/avatar/AvatarProfileTrustBoundary.js's own header already gives.
export class AvatarInteractionTrustBoundary {
    // 0.2.60 — `isBlocked`: see application/presence/PresenceTrustBoundary.js's
    ...
    evaluate(incomingAdvertisement) {
        ...
        // 0.2.60 — see application/presence/PresenceTrustBoundary.js's own
