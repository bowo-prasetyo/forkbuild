...
} from '../snapshot/placement/SnapshotPlacementKnowledgeRecord.js';
...
//
// application/anchoring/LocalAnchorKnowledgeStore.js's own class (0.8.17), applied
...
// the exact split application/anchoring/AnchorKnowledgeRecord.js's own header draws
...
// exactly as application/anchoring/LocalAnchorKnowledgeStore.js's own header
...
export class LocalPlacementKnowledgeStore {
    ...
    // `acquisitionKind` (an application/placement/PlacementAcquisitionKind.js
    ...
    // exactly like application/snapshot/placement/LocalPublicationSnapshotPlacementCatalog.js
