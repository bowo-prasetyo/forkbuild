...
// (`application/publication/observationArchive/PublicationObservationArchive.js` and everything reading
...
// milestone keeps is `application/publisher/PublisherPublicationAssociationRecord.js`'s
...
// already holds (`application/anchoring/BlockchainPublicationIdentity.js`, 0.8.89;
// `application/publication/PublicationReferenceRecord.js`, 0.8.104). Every field is
