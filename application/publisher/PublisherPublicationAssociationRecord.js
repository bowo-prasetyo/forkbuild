...
// it" — see `application/publisher/PublisherIdentityRecord.js`'s own header for why
...
// `application/publisher/PublisherIdentityRecord.js` (0.8.108) instance;
...
// exist — see `application/publisher/CreatePublisherPublicationAssociationRecordUseCase.js`'s
...
// already holds (`application/publication/PublicationReferenceRecord.js`, 0.8.104).
