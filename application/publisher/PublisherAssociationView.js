...
// see that class's own header, and `application/publisher/PublisherIdentityRecord.js`'s
...
// same restraint `application/achievement/AchievementProfileView.js`'s own profile
// already holds for an untouched publication identity.
//
// NO ACHIEVEMENT AGGREGATION, NO SCORE, NO RANK. This file does not read
// `application/achievement/AchievementEvent.js`, does not compose any publication's
...
// archive-reading entry point, mirroring `application/achievement/AchievementProfileView.js`'s
