...
// application/blueprint/ExportBlueprintUseCase.js:
//
...
//
//   1. validate  — application/blueprint/BlueprintImportValidator.js#validateBlueprintPackage()
//   2. construct — a brand-new, independent core/Structure.js
//   3. (persistence is the CALLER's job — see application/editor/EditorSession.js#importBlueprint())
//
...
// application/editor/ForkStructureUseCase.js and
// application/editor/CreateStructureFromSelectionUseCase.js already apply to
...
export class ImportBlueprintUseCase {
    ...
    // application/blueprint/BlueprintImportValidator.js's own header on why that
    // check needs one.
