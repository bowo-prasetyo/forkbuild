...
//
// The first concrete `kindPlugin` for application/publication/PublicationResolver.js
...
// application/placeNaming/PlaceNamingClaimPublicationKind.js as a second, deliberately
...
// replacement for application/blueprint/BlueprintAttributionExchange.js's own
...
// wrong subject" defense application/blueprint/BlueprintAttributionExchange.js's
...
// resolves to (application/publication/PublicationResolutionCoordinator.js, driving
// the Publications Center this milestone adds) never persists it into
// application/blueprint/LocalBlueprintAttributionStore.js as a side effect of
// merely checking. Per application/publication/PublicationResolver.js's own header,
...
export function createBlueprintAttributionPublicationKind({ verifier, store = null, expectedFingerprint = null }) {
    ...
    if (store) {
        ...
        // application/blueprint/BlueprintAttributionExchange.js#importAttribution()
