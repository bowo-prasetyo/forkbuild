...
// exactly the cost application/blueprint/LocalBlueprintAttributionStore.js already
...
export class LocalBlueprintLineageClaimStore {
    ...
    // exchange transport" dedup application/blueprint/BlueprintLineageExchange.js
    // needs, mirroring application/blueprint/LocalBlueprintAttributionStore.js#has().
    ...
    // already keeps (see application/blueprint/LocalBlueprintAttributionStore.js#
