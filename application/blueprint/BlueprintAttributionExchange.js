...
// 0.6.5 left it — application/blueprint/BlueprintAttributionUseCase.js#summarize() —
...
// application/blueprint/BlueprintPackage.js's own 0.6.6 `attributions` field), that
...
export class BlueprintAttributionExchange {
    ...
    // application/placeNaming/PlaceNamingClaimPublication.js one domain over). Throws
    ...
    // adds at the end:
    //
    //   1. validate  — application/blueprint/BlueprintAttributionPublicationValidator.js
    ...
    // signed payload — the exact `application/placeNaming/LocalPlaceNamingClaimStore.js#has()`
    // reasoning applied here to `application/blueprint/LocalBlueprintAttributionStore.js#has()`
