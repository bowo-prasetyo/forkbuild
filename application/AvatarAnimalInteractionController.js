...
//
// The animal counterpart of application/AvatarVehicleInteractionController.js
...
// application/AvatarInventoryStore.js's own header for why ownership of
...
export class AvatarAnimalInteractionController {
    ...
    // application/AvatarVehicleInteractionController.js#tick() already
    ...
    // application/AnimalRuntimeInstances.js#discard(). Returns whether a
    ...
    // application/AvatarVehicleInteractionController.js#_tickDeploy()
    ...
    // identical restraint
    // application/AvatarVehicleInteractionController.js#_tickDeploy()'s
    ...
    _nearbyAnimals(avatarPosition) {
        ...
        // — see application/AnimalRuntimeInstances.js#isExcluded()'s own
...
// application/AvatarMovementController.js, the identical "no movement
