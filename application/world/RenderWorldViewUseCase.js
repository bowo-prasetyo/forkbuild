...
export class RenderWorldViewUseCase {
    execute(container, registry, eventBus = null, { gestureService = null, structureResolver = null } = {}) {
        ...
        // documentId one application/editor/StructureDocumentResolver.js
        ...
        const pickingService = new PickingService(
            ...
            // application/world/RenderWorldUseCase.js's identical wiring for
            // the Editor.
        ...
        // DEFAULT_MAX_WALKING_DEPTH (application/avatar/AvatarWaterConstraint.js's
        ...
        return {
            ...
            // application/world/RenderWorldUseCase.js's identical Editor-side
            // surface.
            ...
            // application/world/WorldNavigationSession.js's
            ...
            // 0.2.36 — lets application/avatar/AvatarMovementController.js
            ...
            // by application/avatar/RemoteAvatarRegistry.js, never directly by
            ...
            // application/avatar/RemoteAvatarAppearanceRegistry.js, only when
            ...
            // by application/world/WorldNavigationSession.js the moment a
            ...
            // application/world/NearbyVehicleInstances.js's own output,
            // supplied once per render frame by
            // application/world/WorldNavigationSession.js's own
            ...
            // RELEASED animals only (application/world/AnimalRuntimeInstances.js#releasedNearby()'s
            ...
            // AvatarPresence#position (application/avatar/AvatarAnimalInteractionController.js#_tickRelease())
