...
export class RenderWorldUseCase {
    execute(container, eventBus, registry, editorEventBus, { gestureService = null, structureResolver = null } = {}) {
        ...
        return {
            ...
            // wire application/editor/EditorSession.js#marqueeSelect() has
            ...
            // application/world/RenderWorldViewUseCase.js already exposes for
            // World View's own camera — added here so
            // application/editor/EditorSession.js#frameCameraOn() has
