...
// application/world/NearbyVehicleInstances.js#VEHICLE_RENDER_RADIUS already
...
//
// The animal counterpart of application/world/VehicleRuntimeInstances.js —
...
//   application/world/VehicleRuntimeInstances.js's own header names for a
...
//   why, the identical reasoning application/world/VehicleRuntimeInstances.js's
...
export class AnimalRuntimeInstances {
    ...
    // (application/avatar/AvatarAnimalInteractionController.js's own
    ...
    // application/world/VehicleRuntimeInstances.js#instances/#excludedIds — see
    ...
    // application/world/VehicleRuntimeInstances.js#nearby()'s own header for
    ...
    // application/world/WorldNavigationSession.js#decorateNearestReleasedAnimalHere()
    ...
    // application/world/VehicleRuntimeInstances.js#add() exactly.
    add(instance) {
    ...
    //
    // `position` (required — application/avatar/AvatarAnimalInteractionController.js
    ...
    // The one caller: application/world/WorldNavigationSession.js seeding a
