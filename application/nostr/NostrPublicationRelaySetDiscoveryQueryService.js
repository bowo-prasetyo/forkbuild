...
// Section (read-side discovery) named: `application/nostr/NostrDiscoveryQueryService.js`
...
//                    │
//                    ▼
//   application/nostr/NostrPublicationRelaySetDiscoveryQueryService.js   ★ (THIS)
...
// AN OVERSIGHT. `application/discovery/DecentralizedWorldDiscoveryQuery.js`'s own
...
//   (`application/nostr/NostrSnapshotDiscoveryQueryService.js`) or place-naming
//   discovery (`application/placeNaming/NostrPlaceNamingDiscoverySource.js`).** Both
