...
//        │  { publish, relayUrl }
//        ▼
//   application/nostr/NostrPublicationDistributionRuntimeAdapter.js   ★ (THIS)
...
// remain exactly `application/nostr/NostrPublicationDiscoveryPublisher.js`'s own
...
// exactly why `application/nostr/NostrPublicationDiscoveryPublisher.js`'s own
...
// SATISFIES. `application/nostr/NostrPublicationDiscoveryPublisher.js`'s own
...
// exactly the restraint `application/publication/distribution/PublicationDistributionRuntimeProvider.js`'s
...
// `application/arweave/ArweavePublicationMaterialUploader.js`, reads no `signer`/
...
//   unscheduled work, exactly as `application/nostr/NostrPublicationDiscoveryPublisher.js`'s
