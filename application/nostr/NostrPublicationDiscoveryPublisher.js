...
// of `application/nostr/NostrDiscoveryQueryService.js` (0.9.31): that file reads
...
//              │
//              ▼
//   application/nostr/NostrPublicationDiscoveryPublisher.js   ★ (THIS)
...
// what `application/nostr/NostrDiscoveryQueryService.js`'s own
...
// THE SAME LINE `application/nostr/NostrDiscoveryQueryService.js`'s OWN HEADER
...
// `application/nostr/NostrDiscoveryQueryService.js`'s own `queryImpl` already
...
// `application/nostr/NostrDiscoveryQueryService.js`'s own header already frames
...
// NostrDiscoveryQueryService.js`, `application/discovery/DecentralizedWorldDiscoveryQuery.js`,
...
// remains entirely `application/publication/distribution/PublicationDistributionDescriptor.js`'s own
...
export class NostrPublicationDiscoveryPublisher {
    ...
    //   defaults to `t`, matching `application/nostr/NostrDiscoveryQueryService.js`'s
