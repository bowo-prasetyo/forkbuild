import { composePublicationMaterialUploader } from '../publication/distribution/PublicationMaterialUploaderComposition.js';
import { describePublicationDistribution } from '../publication/distribution/PublicationDistributionDescriptor.js';
import { describePublicationDistributionResult } from '../publication/distribution/PublicationDistributionResult.js';
...
//                    │
//                    ▼
//   application/nostr/NostrMultiRelayPublicationDistributionOrchestrator.js  ★ (THIS)
...
// (`application/publication/distribution/PublicationDistributionCommand.js`'s own 0.9.444 amendment)
...
//   `application/publication/distribution/PublicationDistributionCommand.js`'s own job, one layer up.
...
// forwarded, verbatim, to `application/publication/distribution/PublicationMaterialUploaderComposition.js`'s
