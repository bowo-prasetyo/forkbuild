...
//
// The vocabulary `application/ipfs/IpfsPublicationContentVerifier.js` reports
// its own single retrieval-and-verify attempt through — deliberately the
// same three values `application/anchoring/bitcoin/BitcoinAnchorContentProofState.js`
