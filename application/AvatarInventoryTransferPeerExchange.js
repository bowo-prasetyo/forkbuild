...
//
// The application/PublicationAnchorPeerExchange.js shape, applied to one
// carried core/AvatarInventory.js entry instead of a signed anchor claim:
// attach to every application/ConnectedPeerRegistry.js peer (now and in
...
// injected application/AvatarInventoryStore.js — the ONE owner of the
...
export class AvatarInventoryTransferPeerExchange {
    ...
    dispose() {
        ...
        // restraint application/PublicationAnchorPeerExchange.js#dispose()
    ...
    // application/PublicationAnchorPeerExchange.js already applies to a
