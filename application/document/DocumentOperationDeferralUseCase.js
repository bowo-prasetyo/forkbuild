...
// (`application/document/RemoteDocumentOperationApplicationUseCase.js`, completely
...
// (`application/editor/CommandHistory.js`'s own header — the ONE chokepoint) —
...
export class DocumentOperationDeferralUseCase {
    ...
    // `application/editor/EditorSession.js`). Two jobs, one registration: lets
