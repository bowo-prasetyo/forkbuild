...
// exactly the way `application/editor/CommandHistory.js` already persists it
...
// cached, mirrors application/chat/ChatUseCase.js#_handleIncoming()'s own
...
//   4. resolve World EDIT authority  — application/identity/WorldAuthorizationService.js,
...
//                                      (application/identity/WorldMembershipUseCase.js)
...
// (application/editor/SpatialEditingService.js, gated by 0.2.95's
...
export class WorldCommandPropagationUseCase {
    constructor({
        ...
        // shape application/identity/WorldMembershipUseCase.js#hasActiveGrant()
    ...
    // event — the SAME event application/editor/CommandHistory.js already
    ...
    _handleIncoming(payload, meta) {
        ...
        // NEVER through the receiver's own `application/editor/CommandHistory.js`
