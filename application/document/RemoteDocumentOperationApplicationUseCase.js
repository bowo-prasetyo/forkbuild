...
//
// 0.9.222 (`application/document/DocumentCommandPropagationUseCase.js`) built the
...
// SAME chokepoint (`application/editor/CommandHistory.js#execute()`) every local
...
export class RemoteDocumentOperationApplicationUseCase {
    ...
    // `CommandHistory` (`application/editor/CommandHistory.js`) backing it. Pass
