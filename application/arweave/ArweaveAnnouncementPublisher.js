...
// convention application/nostr/NostrPublicationDiscoveryPublisher.js already
...
// change to that file, `application/publication/distribution/PublicationDistributionDescriptor.js`
// (0.9.44), or `application/publication/distribution/PublicationDistributionResult.js` (0.9.48) — the
...
//              │
//              ▼
//   application/arweave/ArweaveAnnouncementPublisher.js   ★ (THIS)
...
// `application/arweave/ArweavePublicationMaterialUploader.js`'s own concern (0.9.45),
...
// `application/publication/distribution/PublicationDistributionExecutor.js`'s own header, "genuine
...
// file never imports `application/arweave/ArweaveGraphqlDiscoveryQueryService.js`,
// `application/discovery/DecentralizedWorldDiscoveryQuery.js`, or any verification
...
//   own `publishImpl`.
// - **Widening `application/arweave/ArweavePublicationMaterialUploader.js`'s or
...
// - **Any change to `application/publication/distribution/PublicationDistributionExecutor.js`,
//   `application/publication/distribution/PublicationDistributionDescriptor.js`, or `application/
