...
//        ▼
//   application/arweave/ArweavePublicationDistributionRuntimeAdapter.js   ★ (THIS)
...
// SAME name `application/arweave/ArweavePublicationMaterialUploader.js`'s own
...
// transaction }>`, exactly the contract `application/arweave/ArweavePublicationMaterialUploader.js`'s
...
// the restraint `application/publication/distribution/PublicationDistributionRuntimeProvider.js`'s
...
// `application/nostr/NostrPublicationDistributionRuntimeAdapter.js`, reads no
...
// `application/publication/distribution/PublicationDistributionRuntimeProvider.js`'s own header
...
//   exactly as `application/arweave/ArweavePublicationMaterialUploader.js`'s own
