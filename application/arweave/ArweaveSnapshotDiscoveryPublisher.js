...
// Deliberately DISTINCT from application/arweave/ArweaveAnnouncementPublisher.js's
...
// runs — application/arweave/ArweaveGraphqlDiscoveryQueryService.js's own
...
// the existing, UNMODIFIED `application/snapshot/DecentralizedSnapshotResolver.js` —
// and that neither `application/arweave/ArweaveAnnouncementPublisher.js` (Section
// G) nor `application/arweave/ArweaveGraphqlDiscoveryQueryService.js` (Section H)
...
//        ▼
//   application/arweave/ArweaveSnapshotDiscoveryPublisher.js   ★ (THIS)
...
// import of `application/arweave/ArweaveGraphqlDiscoveryQueryService.js` or any
...
// with Nostr (no import of `application/nostr/NostrSnapshotDiscoveryPublisher.js`
...
//
// REUSES `application/arweave/ArweaveTaggedTransactionUpload.js`'S OWN UPLOAD
// PRIMITIVE, UNCHANGED — NEVER `application/arweave/ArweaveAnnouncementPublisher.js`
...
//
//   Publication announcement   -> application/arweave/ArweaveAnnouncementPublisher.js   -> uploadTaggedTransaction
//   Snapshot announcement      -> application/arweave/ArweaveSnapshotDiscoveryPublisher.js (THIS) -> uploadTaggedTransaction
//
...
// `application/nostr/NostrSnapshotDiscoveryPublisher.js`'s OWN HEADER ALREADY
...
// `application/arweave/ArweaveAnnouncementPublisher.js`'s OWN HEADER ALREADY NAMES,
...
// or calls `application/nostr/NostrSnapshotDiscoveryPublisher.js` — selecting
...
//   `application/arweave/ArweaveTaggedTransactionUpload.js`, `application/
...
//   this pair into `application/snapshot/SnapshotCandidateDiscoveryQueryService.js`,
...
export class ArweaveSnapshotDiscoveryPublisher {
    ...
    //   mirrors `application/arweave/ArweaveAnnouncementPublisher.js`'s own
    //   `relayUrl` field.
    ...
    //   `application/nostr/NostrSnapshotDiscoveryPublisher.js`'s own 0.9.171
