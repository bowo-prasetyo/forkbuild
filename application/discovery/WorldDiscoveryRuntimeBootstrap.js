...
import { describeLocalWorldDiscoverySource } from '../worldEncounter/WorldEncounterIntegration.js';
...
// `application/peer/ConnectedPeerRegistry.js` instance and `peer/
...
// `connectedPeer` — SEE `application/peer/ConnectedPeer.js`'s OWN "CLOSING
// DISCARDS remoteIdentity." By the time `connectedPeerRegistry.onChange()`
// notifies this file that a connection is gone,
// `application/peer/ConnectedPeerRegistry.js` has already called that peer's
