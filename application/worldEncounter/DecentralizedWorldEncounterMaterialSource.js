...
// `application/worldEncounter/DecentralizedWorldEncounterLeadResolution.js`,
// `application/discovery/DecentralizedWorldDiscoveryLeadRegistry.js`,
// `core/DecentralizedWorldEncounterLeadAssociation.js`, or
// `application/discovery/DecentralizedWorldDiscoveryQuery.js`. It is handed a
...
// happens to supply. `application/worldEncounter/WorldEncounterMaterialLoading.js`
...
// `application/worldEncounter/WorldEncounterMaterialLoading.js`'s own header's "zero/
...
//   `application/worldEncounter/DecentralizedWorldEncounterLeadResolution.js`'s (0.9.28)
//   own job, already finished before this file is ever called.
// - **Wiring this class into `application/worldEncounter/WorldEncounterMaterialLoading.js`'s
