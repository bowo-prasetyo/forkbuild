...
// STRING SHAPE, NEVER A NEW TAXONOMY. `application/worldEncounter/WorldEncounterMaterialLoading.js`'s
...
// no per-service breakout (mirroring `application/publication/distribution/PublicationMaterialProvenance.js`'s
...
// yet, or `'UNAVAILABLE'` — see `application/worldEncounter/WorldEncounterSelectionOutcome.js`'s
...
// renamed" restraint `application/worldEncounter/WorldEncounterReadModel.js`'s own header
...
// materialized Snapshot — `application/snapshot/materialization/MaterializedSnapshotWorldDiscoveryBridge.js`'s
...
// nothing to present" reading `application/worldEncounter/WorldEncounterInspection.js`
...
//
// `inspection`         — `application/worldEncounter/WorldEncounterInspection.js`'s own
