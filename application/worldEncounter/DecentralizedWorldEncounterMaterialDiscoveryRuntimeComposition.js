import { NostrDiscoveryQueryService } from '../nostr/NostrDiscoveryQueryService.js';
import { NostrPublicationRelaySetDiscoveryQueryService } from '../nostr/NostrPublicationRelaySetDiscoveryQueryService.js';
import { ArweaveGraphqlDiscoveryQueryService } from '../arweave/ArweaveGraphqlDiscoveryQueryService.js';
import { DecentralizedWorldDiscoveryLeadRegistry } from '../discovery/DecentralizedWorldDiscoveryLeadRegistry.js';
import { queryDecentralizedWorldDiscoveryIntoRegistry } from '../discovery/DecentralizedWorldDiscoveryQueryRegistryBridge.js';
...
import { describePublicationMaterialProvenanceFromInspection } from '../publication/distribution/PublicationMaterialProvenance.js';
...
export function composeDecentralizedWorldEncounterMaterialDiscoveryRuntime({
    ...
    async function discoverWorldEncounterPublication({ objectId, discoveryTag, publications } = {}) {
        ...
        // `application/publication/distribution/PublicationMaterialProvenance.js`'s own header.
