...
//
// application/anchoring/bitcoin/BitcoinAnchorPublicationRecord.js (0.8.80) gives this replica
// a durable IDENTITY for one Bitcoin anchor publication attempt.
// application/anchoring/bitcoin/BitcoinAnchorObservationEvidenceView.js (0.8.78) already puts
...
//        │
//        ├──► broadcastObservations       (application/anchoring/bitcoin/BitcoinAnchorBroadcastView.js)
//        ├──► confirmationObservations    (application/anchoring/bitcoin/BitcoinAnchorConfirmationObservationHistoryView.js)
//        ├──► contentProofObservations    (application/anchoring/bitcoin/BitcoinAnchorContentProofView.js)
...
// application/anchoring/bitcoin/BitcoinAnchorReviewedSigningState.js or application/
...
// application/publication/observationArchive/PublicationObservationArchive.js's own header on exactly
...
// application/publication/observationArchive/PublicationObservationTimelineView.js's own header already
...
// (0.8.76) and application/anchoring/bitcoin/BitcoinAnchorObservationConsistencyAnalyzer.js#
...
// (0.8.78) and application/anchoring/bitcoin/BitcoinAnchorObservationEvidenceView.js#
...
// application/anchoring/bitcoin/BitcoinAnchorObservationEvidence.js's own header already
...
// ITS OWN — application/anchoring/bitcoin/BitcoinAnchorChainPlacementObserver.js's own
// `comparisons` and application/anchoring/bitcoin/BitcoinAnchorObservationConsistencyAnalyzer.js's
...
// archive — mirroring application/anchoring/bitcoin/BitcoinAnchorDurableEvidenceView.js's
...
// application/anchoring/bitcoin/BitcoinAnchorBroadcastView.js, application/
