...
// application/anchoring/CreateExternalPublicationAnchorUseCase.js (0.8.10) already
...
// application/anchoring/bitcoin/BitcoinAnchorPublicationLifecycleState.js's own vocabulary.
//
...
// succeed (see application/anchoring/bitcoin/BitcoinAnchorPublicationLifecycleState.js's own
...
// application/anchoring/ExternalAnchorVerifier.js — this class never queries that,
...
// application/anchoring/CreatePublicationAnchorUseCase.js and anchoring/
...
export class BitcoinAnchorPublicationCoordinator {
    ...
    // pipeline: application/anchoring/bitcoin/BitcoinAnchorTransactionConstructionCoordinator.js
    // (0.8.61) → application/anchoring/bitcoin/BitcoinAnchorTransactionReviewCoordinator.js
    // (0.8.62) → application/anchoring/bitcoin/BitcoinAnchorReviewedSigningCoordinator.js
    // (0.8.62, review-preserving — see anchoring/BitcoinAnchorReviewedPsbtSigner.js's
    // own header) → application/anchoring/bitcoin/BitcoinAnchorSignedPsbtFinalizationCoordinator.js
    // (0.8.63) → application/anchoring/bitcoin/BitcoinAnchorBroadcastCoordinator.js (0.8.64).
    ...
    // application/anchoring/bitcoin/BitcoinAnchorPublicationRecord.js, a local, UI-level
    ...
    // application/anchoring/bitcoin/BitcoinAnchorBroadcastCoordinator.js — this method is
    ...
    // exactly how application/anchoring/bitcoin/BitcoinAnchorBroadcastCoordinator.js#broadcast()
