...
//
// application/anchoring/bitcoin/BitcoinAnchorConfirmationObservationHistoryView.js's own
// `describeBitcoinAnchorConfirmationStateLabel()` (0.8.54/0.8.56) already
// turns `application/anchoring/bitcoin/BitcoinAnchorConfirmationState.js`'s vocabulary into a
// factual sentence. This file is the identical, missing counterpart for
// `application/anchoring/bitcoin/BitcoinAnchorContentProofState.js` (0.8.55) — the one small
...
//        (application/anchoring/bitcoin/BitcoinAnchorProofReconciliationView.js's own
//        `contentProof` shape) except `stateLabel`, which is new.
//
// THE ONE RULE THIS FILE EXISTS TO ENFORCE, restated one domain over from
// application/anchoring/bitcoin/BitcoinAnchorConfirmationObservationHistoryView.js's own: the
...
// reads `application/anchoring/bitcoin/BitcoinAnchorConfirmationState.js`'s own vocabulary,
