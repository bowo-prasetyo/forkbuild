...
// has seen. This class is application/publication/LocalPublicationCatalog.js's own
...
// locators. add() never calls application/anchoring/ExternalAnchorVerifier.js,
...
// application/anchoring/ExternalAnchorVerifier.js separately, every time, and
...
// identical reason application/publication/LocalPublicationCatalog.js's own header
...
// application/anchoring/ExternalAnchorVerifier.js#verify() unchanged.
//
...
// property application/publication/LocalPublicationCatalog.js's own `publication.id`
// dedup already gives publications.
//
// First-seen-wins, exactly like application/publication/LocalPublicationCatalog.js#
...
// now delegates to application/anchoring/LocalPublicationAnchorStore.js, the named
...
// question — application/anchoring/RestorePublicationAnchorCatalogUseCase.js's own,
...
export class LocalPublicationAnchorCatalog {
    ...
    // application/anchoring/AddPublicationAnchorUseCase.js, the ordinary way an
    ...
    // mirrors application/publication/LocalPublicationCatalog.js#remove()'s own
