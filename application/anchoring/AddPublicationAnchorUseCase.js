...
// shorter than application/publication/PublicationExchange.js#importPublication()'s
// own three:
//
...
//
//   → catalog    — application/anchoring/LocalPublicationAnchorCatalog.js#add()
//
...
// application/publication/PublicationExchange.js does for a DecentralizedPublication
...
// See application/anchoring/LocalPublicationAnchorCatalog.js's own header and
...
// trustworthy calls application/anchoring/ExternalAnchorVerifier.js separately,
...
export class AddPublicationAnchorUseCase {
    ...
    // entirely to application/anchoring/ExternalAnchorVerifier.js, never to this
    // class.
    execute(anchorJson) {
