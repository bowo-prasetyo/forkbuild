...
// imports application/anchoring/ExternalAnchorVerifier.js — see tests/
...
// same way application/blueprint/BlueprintAttributionUseCase.js#publish() already
...
// application/anchoring/AnchorAcquisitionKind.js#LOCAL knowledge entry (see the
...
export class CreatePublicationAnchorUseCase {
    ...
    // anchor. See application/anchoring/AnchorKnowledgeRecord.js's own header.
    ...
    execute(publicationId, { anchorType, locator, proof = null, anchoredAt = new Date() } = {}) {
        ...
        // discipline application/blueprint/BlueprintAttributionUseCase.js#publish()
