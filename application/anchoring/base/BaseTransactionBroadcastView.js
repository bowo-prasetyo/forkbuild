...
//
// The label vocabulary for `application/anchoring/base/BaseTransactionBroadcastState.js`,
// and the projection `application/anchoring/base/BaseTransactionBroadcastCoordinator.js`'s
// own outcome is turned into a screen's worth of facts through — mirroring
// exactly how `application/anchoring/bitcoin/BitcoinAnchorBroadcastView.js` (0.8.64) turns
...
// `application/anchoring/base/BaseTransactionBroadcastState.js`'s own header, "THIS IS
