...
// plan — `application/anchoring/base/BasePublicationTransactionPlanCoordinator.js#construct()`'s
...
// place (`application/anchoring/base/BasePublicationCommitmentEncoding.js`, 0.8.91,
...
// exactly as `application/anchoring/base/BasePublicationTransactionPlanView.js`'s own
...
// and `application/anchoring/bitcoin/BitcoinAnchorTransactionReviewView.js`'s own "Throws
...
// `application/anchoring/BlockchainPublicationIdentity.js` (0.8.89) — there has been
