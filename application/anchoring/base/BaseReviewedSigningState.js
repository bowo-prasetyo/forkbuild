...
//
// The vocabulary `application/anchoring/base/BaseReviewedSigningCoordinator.js` reports
...
// `application/anchoring/bitcoin/BitcoinAnchorReviewedSigningState.js`'s own header (0.8.62)
