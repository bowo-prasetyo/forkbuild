...
// second one; application/anchoring/LocalPublicationAnchorCatalog.js's own id-based
...
export class CreateExternalPublicationAnchorUseCase {
    ...
    // application/anchoring/ExternalAnchorCreationOutcome.js's own values, `anchor`
    ...
    // application/anchoring/CreatePublicationAnchorUseCase.js already gives for an
    ...
    async execute(publicationId, anchorType) {
        ...
        // at all. application/anchoring/CreatePublicationAnchorUseCase.js re-derives
