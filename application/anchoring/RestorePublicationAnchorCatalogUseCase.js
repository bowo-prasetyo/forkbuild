...
//
// application/anchoring/LocalPublicationAnchorCatalog.js has always been backed by
...
// could be exactly what application/anchoring/PublicationAnchorExchange.js#
...
// origin's storage. application/anchoring/LocalPublicationAnchorStore.js's own
...
// startup (see application/anchoring/CreatePublicationAnchorPeerExchangeUseCase.js)
...
//
//   1. validate  — application/anchoring/PublicationAnchorValidator.js (is this
...
// This class never imports application/anchoring/ExternalAnchorVerifier.js, never
...
// same act as application/anchoring/LocalPublicationAnchorCatalog.js#remove()
...
// way. application/anchoring/LocalPublicationAnchorCatalog.js already serves it,
...
export class RestorePublicationAnchorCatalogUseCase {
    // store: an application/anchoring/LocalPublicationAnchorStore.js instance —
    // the SAME one application/anchoring/LocalPublicationAnchorCatalog.js was
    ...
    // application/anchoring/ExternalAnchorVerifier.js. See this class's own header.
    ...
    // tolerance application/anchoring/ImportPackageAnchorsUseCase.js already applies
