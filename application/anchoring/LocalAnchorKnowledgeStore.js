...
//
// application/anchoring/LocalPublicationAnchorCatalog.js answers "what evidence
...
// .js, application/anchoring/ImportPackageAnchorsUseCase.js, and application/
...
// See application/anchoring/AnchorKnowledgeRecord.js's own header.
//
...
export class LocalAnchorKnowledgeStore {
    ...
    // `acquisitionKind` (an application/anchoring/AnchorAcquisitionKind.js value).
    // `firstSeenAt` is this replica's own local clock, exactly like
    // application/anchoring/LocalPublicationAnchorStore.js#save()'s own
    ...
    // IS cataloged (application/anchoring/AddPublicationAnchorUseCase.js's own
    ...
    // like application/anchoring/LocalPublicationAnchorCatalog.js#remove() — never
    ...
    // exactly as application/anchoring/LocalPublicationAnchorCatalog.js#list() does
