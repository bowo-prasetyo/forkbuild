...
//
// application/publication/PublicationPeerExchange.js's own class, applied to an
...
// incoming ANNOUNCE through application/anchoring/PublicationAnchorExchange.js#
...
// exactly what application/anchoring/PublicationAnchorExchange.js#importAnchor()
...
// application/anchoring/PublicationAnchorExchange.js) is the only thing that ever
...
// calls application/anchoring/ExternalAnchorVerifier.js either, and a RESPONSE
...
// metadata (see application/anchoring/PublicationAnchorPeerProtocol.js#
...
// down inside application/anchoring/LocalPublicationAnchorStore.js.
export class PublicationAnchorPeerExchange {
    // knowledgeStore: OPTIONAL, an application/anchoring/LocalAnchorKnowledgeStore.js
    // instance (0.8.17). When supplied, every anchor this class
    // successfully imports — via ANNOUNCE or RESPONSE, `isNew` either way
    // — also records an application/anchoring/AnchorAcquisitionKind.js#PEER
    ...
    // fire-and-forget shape application/peer/PeerContentExchange.js#request()
    ...
    // application/anchoring/ExternalAnchorVerifier.js — this event reports "a new
    ...
    // application/anchoring/PublicationAnchorExchange.js#importAnchor() UNCHANGED
    ...
    //
    // Never calls application/anchoring/ExternalAnchorVerifier.js from ANY branch
    ...
    // (application/anchoring/AddPublicationAnchorUseCase.js tolerates an unsigned
    ...
    // runs through the IDENTICAL application/anchoring/PublicationAnchorExchange.js
    ...
    // `isNew` either way; application/anchoring/LocalAnchorKnowledgeStore.js#
