...
//
// application/blueprint/ImportBlueprintUseCase.js stays exactly what 0.6.6 already
...
// bundled `anchors` (application/blueprint/BlueprintPackage.js, 0.8.7) — never a
...
//
// Deliberately never calls application/anchoring/ExternalAnchorVerifier.js. See
...
// publication is application/publication/evidence/PublicationEvidenceConvergence.js's own
...
// application/anchoring/PublicationAnchorPeerExchange.js's own per-envelope
...
export class ImportPackageAnchorsUseCase {
    // anchorExchange: an application/anchoring/PublicationAnchorExchange.js instance
    ...
    // application/anchoring/AnchorAcquisitionKind.js#PACKAGE knowledge entry. Called
    // unconditionally, on every anchor, every time: FIRST-SEEN-WINS inside
    // application/anchoring/LocalAnchorKnowledgeStore.js#record() is what makes that
    ...
    // `pkg`: a Blueprint Package (application/blueprint/BlueprintPackage.js) that
    // has already passed application/blueprint/BlueprintImportValidator.js#
