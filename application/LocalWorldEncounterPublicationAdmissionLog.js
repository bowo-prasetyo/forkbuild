...
//
// application/LocalPublicationCatalog.js — the class that already solves
// this for the OTHER admission path (application/PublicationExchange.js,
// resolved via application/ReconstructPublicationDiscoveryUseCase.js) — is
...
// codebase already uses (application/LocalBlueprintAttributionPublicationLog.js,
// application/LocalPlaceNamingPublicationLog.js), never a rename or
...
// application/PublicationResolver.js — it is a strictly LOCAL, strictly
...
export class LocalWorldEncounterPublicationAdmissionLog {
    ...
    // application/LocalPublicationCatalog.js#add(): re-admitting the same
