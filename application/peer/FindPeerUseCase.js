...
// delegation to application/peer/PeerSessionManager.js's own discovery pool —
...
// application/peer/ConnectToPeerUseCase.js#_guardExpectedIdentity, the exact
// same 0.2.62 gate application/peer/PeerReconnectionUseCase.js already reuses
...
// this rejection touches application/peer/PeerRelationshipUseCase.js — a
...
export class FindPeerUseCase {
    ...
    // see application/peer/PeerSessionManager.js#importCandidate. Someone else
    ...
    // application/peer/PeerSessionManager.js#discoverCandidates's own header.
    ...
    // to application/peer/PeerSessionManager.js's own publishSelf()/
    ...
    // application/peer/ConnectToPeerUseCase.js has already closed the
