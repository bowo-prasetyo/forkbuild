...
// nothing. application/peer/PeerSessionManager.js already guarantees every
...
// application/peer/ConnectToPeerUseCase.js#_guardExpectedIdentity, layered
...
// to reconnect to; application/peer/ConnectToPeerUseCase.js would simply hand
...
export class PeerReconnectionUseCase {
    ...
    // application/peer/PeerSessionManager.js#createInvitation, tagged with
    // the remembered identity this attempt expects to authenticate.
    // Throws for an identityId this device never chose to "Remember" —
    // see application/peer/PeerRelationshipUseCase.js's own header on why
    ...
    // relationship's own alias (application/peer/ConnectedPeer.js#setAlias,
    ...
    //
    // application/peer/ConnectToPeerUseCase.js#_guardExpectedIdentity registers
