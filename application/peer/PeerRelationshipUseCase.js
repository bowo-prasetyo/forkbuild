...
// application/peer/ConnectedPeerRegistry.js (live, but never persisted).
//
...
// once, reused after" shape application/avatar/AvatarProfileUseCase.js
...
// around. Nothing in this file, in application/peer/PeerSessionManager.js,
// or in application/peer/ConnectToPeerUseCase.js ever calls rememberPeer()
...
export class PeerRelationshipUseCase {
    ...
    // own header for why: only application/peer/ConnectedPeer.js#remoteIdentity,
    ...
    // application/peer/ConnectedPeerRegistry.js#onChange's own shape so a UI
