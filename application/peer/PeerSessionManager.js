...
// composes: application/peer/DiscoverPeersUseCase.js (invitation creation/
// import), application/peer/ConnectToPeerUseCase.js (connection + 0.2.49
// authentication, and the application/peer/ConnectedPeerRegistry.js it
...
// application/peer/PeerReconnectionUseCase.js, the one caller that ever
// supplies it.
//
...
export class PeerSessionManager {
    ...
    // application/peer/ConnectedPeerRegistry.js#connectedSince.
    ...
    // 0.2.62 — re-exposes application/peer/ConnectToPeerUseCase.js's own
    ...
    // matches `identityId` — see application/peer/DiscoverPeersUseCase.js#discover
    ...
    //
    // Return shape is exactly whatever application/peer/DiscoverPeersUseCase.js#publish
    ...
    // application/peer/ConnectedPeerRegistry.js's own header. There is no
