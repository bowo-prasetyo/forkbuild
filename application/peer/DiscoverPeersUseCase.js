...
// the same division application/identity/IdentityUseCase.js already keeps between
...
// whatever connection application/peer/ConnectToPeerUseCase.js opens to a
...
export class DiscoverPeersUseCase {
    ...
    // instead, the shape application/peer/PeerSessionManager.js is actually
    ...
    // a caller checking `Boolean(result)` (application/peer/PeerSessionManager.js#publishSelf)
