...
//
// 0.7.4's application/peer/PeerContentExchange.js#request() asks exactly one
...
// verifies (application/peer/PeerContentExchange.js#onContentReceived() only
...
// unproven until application/peer/PeerContentExchange.js's own hash check
...
// every caller of application/publication/PublicationResolver.js#resolve() to also
// understand peer-retrieval bookkeeping it may not have asked for.
// application/publication/PublicationResolutionCoordinator.js is the one place that
...
export class PeerContentRetrievalCoordinator {
    ...
    // scratch" posture application/publication/PublicationResolutionCoordinator.js's
...
// Same default as application/publication/PublicationResolutionCoordinator.js's own
