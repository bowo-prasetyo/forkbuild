...
// exists, unmodified: application/peer/FindPeerUseCase.js#search()/#connect() is
...
// over — application/peer/PeerRelationshipUseCase.js#getRelationships(), and
...
// in shape, composed the exact way application/peer/PeerReconnectionUseCase.js
...
// discovers a candidate (application/peer/FindPeerUseCase.js#search() does,
// unmodified), never authenticates one (application/
// ConnectToPeerUseCase.js does, unmodified, underneath #connect()), never
// syncs Publications (application/publication/PublicationPeerConnectionSync.js already
...
export class AutoConnectKnownPeersUseCase {
    ...
    async _attempt(identityId) {
        ...
        try {
            ...
            // application/peer/FindPeerUseCase.js's own identity-mismatch guard)
