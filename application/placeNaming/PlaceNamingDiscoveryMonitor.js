...
// `application/snapshot/ShouldRefreshSnapshotDiscovery.js`'s own header already
...
// `application/snapshot/WorldSnapshotDiscoveryMonitor.js` (0.9.186) already
...
// to `application/placeNaming/LocalPlaceNamingClaimStore.js`, never calls
...
// `application/placeNaming/PlaceNamingDiscoveryQueryService.js`'s own,
...
// holding the current World layout (`application/world/WorldNavigationSession.js`,
// via `application/world/WorldLocationDirectory.js`) can answer. So this file
...
//   remains entirely `application/placeNaming/PlaceNamingDiscoveryRuntimeComposition.js`'s
