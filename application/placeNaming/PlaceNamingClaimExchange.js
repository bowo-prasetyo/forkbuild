...
// application/blueprint/ExportBlueprintUseCase.js/ImportBlueprintUseCase.js's own
...
// core/PlaceNamingView.js or application/placeNaming/LocalPlaceNamingClaimStore.js
// directly.
export class PlaceNamingClaimExchange {
    ...
    // already has — see application/placeNaming/PlaceNamingClaimPublication.js's own
    ...
    // side, exactly like application/blueprint/ExportBlueprintUseCase.js never
    ...
    //
    //   1. validate  — application/placeNaming/PlaceNamingClaimPublicationValidator.js
    ...
    // bad" the way application/blueprint/ImportBlueprintUseCase.js's own header
    // insists a blueprint import must not either.
    //
    // Deduplicates by the claim's own `id` — see
    // application/placeNaming/LocalPlaceNamingClaimStore.js#has()'s own header on why
