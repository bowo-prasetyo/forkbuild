...
// `application/snapshot/DiscoverSnapshotRuntimeComposition.js` (0.9.142/0.9.151)
...
//        │
//        ▼
//   application/placeNaming/PlaceNamingDiscoveryRuntimeComposition.js   ★ (THIS)
...
//        (application/placeNaming/DiscoverPlaceNamingClaimsCommand.js, 0.9.253, unmodified —
...
// import `application/placeNaming/DiscoverPlaceNamingClaimsCommand.js`. Every
// behavior a caller observes through the returned `queryService` is
// entirely `application/placeNaming/PlaceNamingDiscoveryQueryService.js`'s own,
// unmodified.
//
...
// never imports `application/snapshot/DiscoverSnapshotRuntimeComposition.js`,
// `application/nostr/NostrSnapshotDiscoveryQueryService.js`, or any
