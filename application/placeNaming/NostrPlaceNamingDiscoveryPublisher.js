...
// decentralized discovery path (`application/placeNaming/NostrPlaceNamingDiscoverySource.js`,
...
//   already locally saved by application/placeNaming/PlaceNamingClaimUseCase.js#publish() —
//   UNMODIFIED by this milestone; see "never a second producer," below)
//                    │
//                    │   claim (an existing, already-signed instance)
//                    ▼
//   application/placeNaming/NostrPlaceNamingDiscoveryPublisher.js   ★ (THIS)
...
// one to `application/placeNaming/LocalPlaceNamingClaimStore.js`. Grep confirms: the
// only production site anywhere in this codebase that ever calls `new
// PlaceNamingClaim(` remains `application/placeNaming/PlaceNamingClaimUseCase.js`
...
// `application/nostr/NostrSnapshotDiscoveryPublisher.js`'s own `publishImpl`
...
// posture `application/placeNaming/PlaceNamingClaimPublication.js#buildPlaceNamingClaimPublication()`
...
// three-way contract `application/nostr/NostrSnapshotDiscoveryPublisher.js`'s
...
// actually discovered is `application/placeNaming/PlaceNamingDiscoveryQueryService.js`'s
...
//   `application/placeNaming/PlaceNamingDiscoveryRuntimeComposition.js`'s `sources`
