...
//
// `application/placeNaming/PlaceNamingDiscoveryQueryService.js` (0.9.253) named the
...
// `application/nostr/NostrSnapshotDiscoveryQueryService.js` (0.9.133) already
...
//        ▼
//   application/placeNaming/NostrPlaceNamingDiscoverySource.js   ★ (THIS)
//        .search(discoveryTag)
//        │
//        │   events, each carrying its own `.content`
//        ▼
//   [ event.content, event.content, ... ]   (raw payload strings, exactly
//        as `application/placeNaming/PlaceNamingDiscoveryQueryService.js`'s own
...
// FROM `application/nostr/NostrSnapshotDiscoveryQueryService.js`'S OWN PATTERN,
...
// `application/nostr/NostrSnapshotDiscoveryQueryService.js`) already holds. A
...
//   `application/nostr/NostrSnapshotDiscoveryPublisher.js`) is a separate,
