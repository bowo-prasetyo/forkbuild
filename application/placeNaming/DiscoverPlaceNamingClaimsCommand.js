...
// `application/snapshot/DiscoverSnapshotCandidatesCommand.js` (0.9.150) already
...
//        │  { discoveryTag }
//        ▼
//   application/placeNaming/DiscoverPlaceNamingClaimsCommand.js   ★ (THIS)
...
// `application/placeNaming/PlaceNamingDiscoveryRuntimeComposition.js`'s (0.9.253,
...
//   into `application/placeNaming/LocalPlaceNamingClaimStore.js`.** A caller who
//   wants to actually ADOPT a discovered candidate does so through
//   `application/placeNaming/PlaceNamingClaimExchange.js#importClaim()` itself, with
