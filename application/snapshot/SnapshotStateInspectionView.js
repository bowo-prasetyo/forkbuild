...
// one snapshot:
//
//   application/snapshot/possession/PublicationSnapshotPossessionView.js        (0.8.39) —
//     does THIS replica's own storage presently hold valid bytes?
//   application/snapshot/PublicationSnapshotAcquisitionView.js       (0.8.43) —
...
//   application/snapshot/placement/PublicationSnapshotPlacementConvergenceView.js (0.8.23) —
//     how many known placements, across how many storage backends and
//     locators, and whether their own contentHash claims agree.
//   application/snapshot/possession/SnapshotPeerPossessionComparisonView.js     (0.8.41) —
