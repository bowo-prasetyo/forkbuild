import { resolveSnapshotWorldPlacement } from './placement/SnapshotWorldPlacement.js';
import { SnapshotWorldPlacementOutcome } from './placement/SnapshotWorldPlacementOutcome.js';
import { registerMaterializedSnapshotWorldSource } from './materialization/MaterializedSnapshotWorldDiscoveryBridge.js';
import { StoreSnapshotContentOutcome } from './materialization/StoreSnapshotContentOutcome.js';
...
// there (see `application/snapshot/WorldSnapshotDiscoveryMonitor.js`'s own header,
...
// OPTIMIZATION. `application/snapshot/placement/SnapshotWorldPositionClaim.js` (0.9.172) gave
...
// `application/snapshot/AutomaticSnapshotEncounterCascadeOutcome.js`'s own
...
// `application/snapshot/placement/SnapshotWorldPositionClaim.js` and never reads
...
// `application/snapshot/placement/SnapshotWorldPlacement.js`'s own "material existence is
...
//   command (application/snapshot/ResolveSelectedSnapshotCommand.js, 0.9.152)
...
//   command (application/snapshot/materialization/MaterializeSelectedSnapshotCommand.js, 0.9.158).
