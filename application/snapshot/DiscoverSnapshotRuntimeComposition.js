...
import { NostrSnapshotDiscoveryQueryService } from '../nostr/NostrSnapshotDiscoveryQueryService.js';
import { NostrMultiRelaySnapshotDiscoveryQueryService } from '../nostr/NostrMultiRelaySnapshotDiscoveryQueryService.js';
import { DecentralizedSnapshotResolver } from './DecentralizedSnapshotResolver.js';

// 0.9.142 — World View Snapshot Discovery Command.
//
// application/snapshot/DiscoverSnapshotCommand.js takes an already-constructed
...
// pair. application/snapshot/SnapshotDistributionRuntimeComposition.js (0.9.137)
...
//        │
//        ▼
//   application/snapshot/DiscoverSnapshotRuntimeComposition.js   ★ (THIS)
...
// entirely application/nostr/NostrSnapshotDiscoveryQueryService.js's,
// application/snapshot/DecentralizedSnapshotResolver.js's, or content/
...
// application/nostr/NostrSnapshotDiscoveryQueryService.js instance... required,
...
// structural distinction application/snapshot/DecentralizedSnapshotResolver.js's
...
// THE SAME RESTRAINT application/snapshot/SnapshotDistributionRuntimeComposition.js'S
...
// file never imports `application/discovery/DecentralizedWorldDiscoveryQuery.js`,
...
// `application/nostr/NostrSnapshotDiscoveryPublisher.js` — composing the
...
// question `application/nostr/NostrSnapshotDiscoveryQueryService.js`'s own
