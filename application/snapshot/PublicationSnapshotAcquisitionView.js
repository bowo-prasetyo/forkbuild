import { describeSnapshotMaterializationSourceCounts, describeSnapshotMaterializationOutcomeCounts } from './materialization/SnapshotMaterializationHistory.js';

// 0.8.43 — Unified Snapshot Acquisition Outcome & Possession UX.
//
// application/snapshot/possession/PublicationSnapshotPossessionView.js (0.8.39) answers "does
...
// caller-supplied application/snapshot/possession/PublicationSnapshotPossessionView.js result)
...
//
// `possessionView`: application/snapshot/possession/PublicationSnapshotPossessionView.js#
...
// `materializationHistory`: an application/snapshot/materialization/SnapshotMaterializationHistory.js
...
// caller directly, mirroring application/snapshot/possession/SnapshotPeerPossessionComparisonView.js#
