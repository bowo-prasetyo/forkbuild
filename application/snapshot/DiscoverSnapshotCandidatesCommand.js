...
// exercised: `application/nostr/NostrSnapshotDiscoveryQueryService.js#search()`
// (0.9.133, unmodified) already answers a completely different question
// than `application/snapshot/DecentralizedSnapshotResolver.js#resolve()` (0.9.134)
...
// boundary" seam `application/snapshot/DiscoverSnapshotCommand.js` (0.9.142)
...
//        │  { discoveryTag }
//        ▼
//   application/snapshot/DiscoverSnapshotCandidatesCommand.js   ★ (THIS)
...
//
// THIS IS A DIFFERENT OPERATION THAN `application/snapshot/DiscoverSnapshotCommand.js`,
...
// itself entirely `application/nostr/NostrSnapshotDiscoveryQueryService.js`'s
...
// unchanged — though `application/nostr/NostrSnapshotDiscoveryQueryService.js`'s
...
//   `application/snapshot/DiscoverSnapshotCommand.js`'s (resolution),
//   `content/ContentStore.js#get()`'s (retrieval), and
//   `application/snapshot/SnapshotPublicationAttribution.js`'s (attribution) own,
...
// own `searchWithOutcome()` (application/snapshot/SnapshotCandidateDiscoveryOutcome.js;
// application/nostr/NostrSnapshotDiscoveryQueryService.js and application/
