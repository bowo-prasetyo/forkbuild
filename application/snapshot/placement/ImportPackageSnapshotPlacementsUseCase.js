...
// bundled `placements` (application/blueprint/BlueprintPackage.js, 0.8.22) — never a
...
// completely unchanged, to application/snapshot/placement/PublicationSnapshotPlacementExchange.js#
...
//
// Deliberately never calls application/snapshot/placement/SnapshotPlacementResolver.js. See
...
// application/anchoring/ImportPackageAnchorsUseCase.js's own per-envelope tolerance
// (0.8.7).
...
export class ImportPackageSnapshotPlacementsUseCase {
    // placementExchange: an application/snapshot/placement/PublicationSnapshotPlacementExchange.js
    // instance — the one and only placement-import boundary this class
    // ever calls.
    //
    // knowledgeStore: OPTIONAL, an application/placement/LocalPlacementKnowledgeStore.js
    ...
    // inside application/placement/LocalPlacementKnowledgeStore.js#record() is what
    ...
    // header, and application/anchoring/ImportPackageAnchorsUseCase.js's own
