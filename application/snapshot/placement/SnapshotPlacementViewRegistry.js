...
//
// application/snapshot/placement/PublicationSnapshotPlacementDetailView.js (this milestone)
...
// lookup seam application/snapshot/placement/SnapshotPlacementStoreRegistry.js (0.8.18)
// already established for RETRIEVAL, applied here to a second,
// independent axis: presentation — the identical relationship
// application/anchoring/ExternalAnchorEvidenceViewRegistry.js (0.8.14) already
// holds to application/anchoring/ExternalProofVerifierRegistry.js (0.8.1) for
// anchors.
//
...
// and application/snapshot/placement/PublicationSnapshotPlacementDetailView.js never
...
export class SnapshotPlacementViewRegistry {
    ...
    // generic application/snapshot/placement/PublicationSnapshotPlacementDetailView.js
