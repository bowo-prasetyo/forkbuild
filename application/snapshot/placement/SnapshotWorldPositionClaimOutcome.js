...
//
// Names the three outcomes `application/snapshot/placement/SnapshotWorldPositionClaim.js#resolveSnapshotWorldPositionClaim()`
// can produce — the identical "as small as possible, name the difference
// structurally" restraint `application/snapshot/placement/SnapshotWorldPlacementOutcome.js`
// (0.9.159) and `application/snapshot/SnapshotPublicationAttributionOutcome.js`
