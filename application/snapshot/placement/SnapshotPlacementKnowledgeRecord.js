import { PlacementAcquisitionKind, isValidPlacementAcquisitionKind } from '../../placement/PlacementAcquisitionKind.js';

// 0.8.24 — Snapshot Placement Provenance & Observation Boundary.
//
// application/anchoring/AnchorKnowledgeRecord.js's own shape (0.8.17), applied to a
...
// deliberately DURABLE (see application/placement/LocalPlacementKnowledgeStore.js),
...
// (see application/placement/LocalPlacementKnowledgeStore.js's own header on why
...
// learned it, exactly as application/anchoring/AnchorKnowledgeRecord.js's own
// header already establishes for anchors.
//
// NOT A TRUST OR AVAILABILITY SIGNAL. `acquisition.kind` is one of
// application/placement/PlacementAcquisitionKind.js's three values, and nothing
...
// exactly as application/anchoring/AnchorKnowledgeRecord.js's own factory never
// checks one either.
