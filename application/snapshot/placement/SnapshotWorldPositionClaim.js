...
// `application/nostr/NostrSnapshotDiscoveryQueryService.js#search()`) to carry an
...
// claim, never a commitment to place"). `application/snapshot/placement/SnapshotWorldPlacement.js`
...
// placement.
//
//   selectedSnapshotCandidate   (application/nostr/NostrSnapshotDiscoveryQueryService.js,
//        │                       0.9.171 — { contentHash, locator, storage,
//        │                       publicationId?, claimedPosition? })
//        │
//        │           target Publication's own `id`   (the SAME Publication
//        │                │                            application/snapshot/placement/SnapshotWorldPlacement.js's
//        │                │                            own `placementInfo`
//        │                │                            argument is already
//        │                │                            keyed to)
//        ▼                ▼
...
// `application/snapshot/placement/SnapshotWorldPositionClaimOutcome.js`'s own header for why
...
// - **Modifying `application/snapshot/placement/SnapshotWorldPlacement.js` or `core/
