...
// (application/settings/RoleAwareProviderResolver.js, 0.9.295) — the ONE outcome
// application/snapshot/placement/PreferredSnapshotPlacementCreationCoordinator.js's own
...
export function describeCreationAttempt(attempt = null) {
    ...
    // message. See application/snapshot/placement/SnapshotPlacementCreationUiState.js's own
    // header.
    if (attempt.error) {
        return {
