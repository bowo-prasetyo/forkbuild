...
import { RoleAwareProviderResolver } from '../../settings/RoleAwareProviderResolver.js';
import { ResolvePreferredRoleProviderUseCase } from '../../settings/ResolvePreferredRoleProviderUseCase.js';
...
// `storeRegistry` (application/snapshot/placement/SnapshotPlacementStoreRegistry.js,
// already built by application/snapshot/placement/CreateSnapshotPlacementOrchestratorUseCase.js)
// into a real application/settings/RoleAwareProviderResolver.js +
// application/settings/ResolvePreferredRoleProviderUseCase.js pair, and returns a
...
// shape application/snapshot/placement/CreateSnapshotPlacementCreationCoordinatorUseCase.js
...
// underlying application/snapshot/placement/CreateExternalSnapshotPlacementUseCase.js — never
...
// CONSULTED. application/settings/RoleAwareProviderResolver.js's own constructor
...
// (see application/snapshot/placement/PreferredSnapshotPlacementCreationCoordinator.js's own
