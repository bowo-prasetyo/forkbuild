...
// evidence. add() never calls application/snapshot/placement/SnapshotPlacementResolver.js,
...
// for the identical reason application/anchoring/LocalPublicationAnchorCatalog.js's
...
// exactly like application/anchoring/LocalPublicationAnchorCatalog.js#add():
...
// now delegates to application/snapshot/placement/LocalPublicationSnapshotPlacementStore.js,
...
// application/anchoring/LocalPublicationAnchorCatalog.js's own header already
...
// (through add(), from application/snapshot/placement/AddPublicationSnapshotPlacementUseCase.js
// or application/snapshot/placement/PublicationSnapshotPlacementExchange.js, both of which
...
export class LocalPublicationSnapshotPlacementCatalog {
    ...
    // see application/snapshot/placement/AddPublicationSnapshotPlacementUseCase.js, the
    ...
    // — mirrors application/anchoring/LocalPublicationAnchorCatalog.js#remove()'s
