...
//
// application/anchoring/PublicationAnchorPeerExchange.js's own class (0.8.4/0.8.5),
...
// entirely inside application/snapshot/placement/PublicationSnapshotPlacementExchange.js) is
...
// import succeeds — mirrors application/anchoring/PublicationAnchorPeerExchange.js's
...
export class PublicationSnapshotPlacementPeerExchange {
    ...
    // — also records an application/placement/PlacementAcquisitionKind.js#PEER
    ...
    // application/placement/PlacementAcquisitionKind.js's own header on why PEER is
    ...
    // fire-and-forget shape application/anchoring/PublicationAnchorPeerExchange.js#
    ...
    // any call to application/snapshot/placement/SnapshotPlacementResolver.js — this event
    ...
    //
    // Never calls application/snapshot/placement/SnapshotPlacementResolver.js from ANY
    ...
    // of its own: application/snapshot/placement/LocalPublicationSnapshotPlacementCatalog.js
