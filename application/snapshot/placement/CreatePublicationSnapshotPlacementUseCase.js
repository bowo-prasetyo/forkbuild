...
// wrote), exactly as application/anchoring/CreatePublicationAnchorUseCase.js's own
...
// application/publication/ResolvePublicationUseCase.js and application/
...
// separate, later action (application/snapshot/placement/SnapshotPlacementResolver.js),
...
// records an application/placement/PlacementAcquisitionKind.js#LOCAL knowledge
...
export class CreatePublicationSnapshotPlacementUseCase {
    ...
    execute(publicationId, { storage, locator, placedAt = new Date() } = {}) {
        ...
        // discipline application/anchoring/CreatePublicationAnchorUseCase.js
        // already applies.
