...
//
// Names the ONLY outcome `application/snapshot/materialization/MaterializedSnapshotWorldDiscoveryBridge.js#
// registerMaterializedSnapshotWorldSource()` invents on its own — narrower
// still than `application/snapshot/placement/SnapshotWorldPlacementOutcome.js` (0.9.159, two
...
export const SnapshotWorldRegistrationOutcome = Object.freeze({
    ...
    // (application/discovery/WorldDiscoverySourceRegistry.js, 0.9.9, UNCHANGED) under
