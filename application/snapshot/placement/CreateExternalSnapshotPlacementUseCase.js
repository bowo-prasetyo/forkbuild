...
export class CreateExternalSnapshotPlacementUseCase {
    ...
    // of application/snapshot/placement/SnapshotPlacementCreationOutcome.js's own values,
    ...
    // application/publication/ResolvePublicationUseCase.js's own identical refusal).
