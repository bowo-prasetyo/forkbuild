...
// deliberately — application/publication/evidence/PublicationEvidenceCoordinator.js's own
// 0.8.3 "what's known"/"does it hold up" pair has an EXACT placement-side
// analogue in application/snapshot/placement/SnapshotPlacementResolutionCoordinator.js
...
// application/snapshot/placement/LocalPublicationSnapshotPlacementCatalog.js directly, never
...
// put them (application/snapshot/placement/CreateExternalSnapshotPlacementUseCase.js,
...
// exactly as application/snapshot/placement/SnapshotPlacementResolutionCoordinator.js's own
// `resolve()` stays separate from application/snapshot/placement/SnapshotPlacementView.js's
// own display derivation.
//
// A SIGNING FAILURE (nobody signed in) is a genuine caller contract
// violation application/snapshot/placement/CreateExternalSnapshotPlacementUseCase.js itself
...
export class SnapshotPlacementCreationCoordinator {
    ...
    // reason }` — application/snapshot/placement/SnapshotPlacementCreationOutcome.js's own
