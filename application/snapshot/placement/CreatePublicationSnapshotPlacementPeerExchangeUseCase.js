...
import { CreatePlacementKnowledgeStoreUseCase } from '../../placement/CreatePlacementKnowledgeStoreUseCase.js';
...
// application/snapshot/placement/LocalPublicationSnapshotPlacementCatalog.js, application/
// PublicationSnapshotPlacementExchange.js, or identity/
// LocalAuthorizationVerifier.js directly — the exact composition-root
// shape application/anchoring/CreatePublicationAnchorPeerExchangeUseCase.js (0.8.4)
...
// ui/main.js) application/snapshot/placement/PublicationSnapshotPlacementPeerExchange.js's
...
// runs application/snapshot/placement/RestorePublicationSnapshotPlacementCatalogUseCase.js
...
export class CreatePublicationSnapshotPlacementPeerExchangeUseCase {
    execute({ peerMessageBus, connectedPeerRegistry } = {}) {
        ...
        // (LOCAL) and application/snapshot/placement/ImportPackageSnapshotPlacementsUseCase.js
