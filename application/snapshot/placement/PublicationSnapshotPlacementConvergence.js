...
// (application/snapshot/placement/LocalPublicationSnapshotPlacementCatalog.js). 0.8.19 gave
...
export function derivePublicationSnapshotPlacementConvergence({
    ...
    return {
        ...
        // application/publication/evidence/PublicationEvidenceConvergence.js's own
