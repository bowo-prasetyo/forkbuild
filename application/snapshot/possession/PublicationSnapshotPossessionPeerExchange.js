...
import { LocalSnapshotContentAvailabilityOutcome } from '../materialization/LocalSnapshotContentAvailabilityOutcome.js';
import {
...
//
// application/snapshot/materialization/PublicationSnapshotContentPeerExchange.js (0.8.37) is the
...
// (attach to application/peer/ConnectedPeerRegistry.js peers now and in the
...
//     silence. See application/snapshot/possession/PeerSnapshotPossessionProtocol.js's own
...
// application/snapshot/possession/PeerSnapshotPossessionProtocol.js's own header because it
...
// and — unlike application/snapshot/materialization/PublicationSnapshotContentPeerExchange.js's own
...
// `application/snapshot/possession/PublicationSnapshotPossessionView.js` (0.8.39) already gives
...
// wire; see application/snapshot/possession/PeerSnapshotPossessionProtocol.js's own header on
// why.
//
...
export class PublicationSnapshotPossessionPeerExchange {
    ...
    // peer sent, application/snapshot/possession/PeerSnapshotPossessionProtocol.js's own
    ...
    // into an application/snapshot/possession/SnapshotPeerPossessionObservation.js record,
    ...
    // mirroring application/snapshot/materialization/PublicationSnapshotContentPeerExchange.js#
    ...
    // own header and application/snapshot/possession/PeerSnapshotPossessionProtocol.js's own
...
// never confused with application/snapshot/materialization/PublicationSnapshotContentPeerExchange.js's
