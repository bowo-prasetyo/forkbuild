...
//
// 0.8.33 built `application/snapshot/materialization/CheckLocalSnapshotContentAvailabilityUseCase.js`
...
// hash?" — and `application/snapshot/materialization/LocalSnapshotContentAvailabilityView.js` to
...
//       possession: { state } }
//
// Deliberately reuses `application/snapshot/materialization/LocalSnapshotContentAvailabilityOutcome.js`'s
...
// computed, mirroring `application/snapshot/materialization/LocalSnapshotContentAvailabilityView.js`'s
...
// `application/anchoring/PublicationAnchorKnowledgeView.js`'s own `null`
...
// outcome `application/snapshot/materialization/LocalSnapshotContentAvailabilityView.js`'s own
