...
//
// application/snapshot/DecentralizedSnapshotResolver.js (0.9.134) already answers
...
//        ▼
//   application/snapshot/DiscoverSnapshotCommand.js   ★ (THIS)
...
//        (application/snapshot/DecentralizedSnapshotResolver.js, 0.9.134, unmodified)
//        │
//        ▼
...
// DISTINCTION application/worldEncounter/DiscoverWorldEncounterPublicationCommand.js'S
...
// itself entirely application/snapshot/DecentralizedSnapshotResolver.js's own,
// unmodified).
//
...
// resolve() caller in application/snapshot/DecentralizedSnapshotResolver.js's own
...
// duplicate a check application/snapshot/DecentralizedSnapshotResolver.js's own
...
// promise unchanged — though application/snapshot/DecentralizedSnapshotResolver.js's
...
// HERE, AND application/snapshot/DecentralizedSnapshotResolver.js'S OWN
// CONSTRUCTOR IS NEVER CALLED. Composing `resolver` itself — which
// concrete Nostr query service backs it — stays entirely its own
// caller's concern (application/snapshot/DiscoverSnapshotRuntimeComposition.js,
// sibling file, or ui/main.js directly), exactly the same restraint
// application/worldEncounter/DiscoverWorldEncounterPublicationCommand.js already holds
