...
import { NostrSnapshotDiscoveryPublisher } from '../nostr/NostrSnapshotDiscoveryPublisher.js';
import { NostrMultiRelaySnapshotDiscoveryPublisher } from '../nostr/NostrMultiRelaySnapshotDiscoveryPublisher.js';
import { ArweaveSnapshotDiscoveryPublisher } from '../arweave/ArweaveSnapshotDiscoveryPublisher.js';

// 0.9.137 — Snapshot Distribution Runtime Composition.
//
// 0.9.136's own header named the exact gap this file closes:
// `application/snapshot/SnapshotDistributionCommand.js` takes an already-constructed
...
//        ▼
//   application/snapshot/SnapshotDistributionRuntimeComposition.js   ★ (THIS)
...
// `application/snapshot/SnapshotDistributionCommand.js`. Its only job is object
...
// `application/nostr/NostrSnapshotDiscoveryPublisher.js`'s own, unmodified.
//
...
// `application/nostr/NostrSnapshotDiscoveryPublisher.js`'s own constructors
...
// `application/snapshot/SnapshotDistributionCommand.js` (0.9.136) already sequences
...
// `application/nostr/NostrPublicationDiscoveryPublisher.js`, or
...
// exactly the two questions `application/nostr/NostrSnapshotDiscoveryPublisher.js`'s
...
// fan-out" invariant `application/publication/distribution/PublicationDistributionRuntimeComposition.js`'s
