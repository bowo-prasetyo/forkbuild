import { WorldEncounterPresentationSourceFamily } from '../worldEncounter/WorldEncounterPresentation.js';
import { materializedSnapshotWorldOrigin } from './materialization/MaterializedSnapshotWorldDiscoveryBridge.js';
...
//
//   selectedEncounterPresentation   (application/worldEncounter/WorldEncounterPresentation.js,
...
//                         `application/worldEncounter/WorldEncounterPresentation.js`'s own
...
//     - `claimedPosition` — `application/snapshot/placement/SnapshotWorldPositionClaim.js`'s
...
// Reuses `application/snapshot/materialization/MaterializedSnapshotWorldDiscoveryBridge.js`'s own
...
//
// `presentation`       — `application/worldEncounter/WorldEncounterPresentation.js`'s own
