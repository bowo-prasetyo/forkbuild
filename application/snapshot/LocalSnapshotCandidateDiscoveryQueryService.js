...
// proved, live, that `application/snapshot/placement/LocalPublicationSnapshotPlacementCatalog.js`
...
// (application/snapshot/SnapshotCandidateDiscoveryQueryService.js, sibling) needs to
...
// `application/snapshot/placement/LocalPublicationSnapshotPlacementCatalog.js` has no
...
// `application/nostr/NostrSnapshotDiscoveryQueryService.js`'s own `search()`
...
// exactly as `application/snapshot/DiscoverSnapshotCandidatesCommand.js`'s own
...
// `application/snapshot/placement/SnapshotPlacementResolver.js`'s own, separate, later
...
// `application/placement/PlacementAcquisitionKind.js`'s own header for exactly where
...
// `application/snapshot/SnapshotCandidateDiscoveryQueryService.js`'s own, separate
// concern.
//
...
//   Stays `application/snapshot/placement/SnapshotPlacementResolver.js`'s own job.
...
export class LocalSnapshotCandidateDiscoveryQueryService {
    ...
    //   `application/snapshot/placement/LocalPublicationSnapshotPlacementCatalog.js` instance
