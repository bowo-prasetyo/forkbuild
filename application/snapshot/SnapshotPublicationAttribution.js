...
//
// application/snapshot/DiscoverSnapshotCommand.js (0.9.142) answered Q1+Q2 of that
...
// `application/snapshot/DecentralizedSnapshotResolver.js#resolve()` (equivalently
// `application/snapshot/DiscoverSnapshotCommand.js#executeDiscoverSnapshotCommand()`)
...
// application/snapshot/SnapshotPublicationAttributionOutcome.js's own header for
...
// error, exactly the restraint `application/snapshot/DecentralizedSnapshotResolver.js#resolve()`
...
//   `MATCH`/`NO_MATCH` (application/snapshot/SnapshotPublicationAttributionOutcome.js)
