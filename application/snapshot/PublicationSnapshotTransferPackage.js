...
import { isValidContentHash } from '../peer/PeerContentProtocol.js';

// 0.8.32 — Explicit Snapshot Content Transfer.
//
// Every offline package this codebase has built since 0.8.7 transfers
// CLAIMS: application/blueprint/BlueprintPackage.js bundles a Structure plus signed
// attributions, application/publication/replica/PublicationReplicaPackage.js (0.8.29) bundles
...
// application/publication/replica/PublicationReplicaPackage.js scopes itself to one
...
// application/snapshot/ImportPublicationSnapshotTransferPackageUseCase.js on
...
//                    application/publication/replica/PublicationReplicaPackage.js's job, not
//                    this one's.
//   contentHash   — the CLAIMED identity of `content`, in the identical
//                    hex-string shape application/peer/PeerContentProtocol.js#
