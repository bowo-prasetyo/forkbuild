...
// application/snapshot/DecentralizedSnapshotResolutionOutcome.js for the complete,
...
// application/snapshot/placement/SnapshotPlacementResolver.js (0.8.18) already holds for a
...
//
// REUSES application/snapshot/placement/SnapshotPlacementStoreRegistry.js AS THE CONTENT
...
// exactly as application/snapshot/placement/SnapshotPlacementResolver.js already does, and
...
// application/nostr/NostrSnapshotDiscoveryQueryService.js#search() — this class
...
// (via `application/snapshot/DiscoverSnapshotCandidatesCommand.js`) already
...
export class DecentralizedSnapshotResolver {
    // queryService: an application/nostr/NostrSnapshotDiscoveryQueryService.js
    ...
    // `application/snapshot/DiscoverSnapshotCandidatesCommand.js`'s own result
