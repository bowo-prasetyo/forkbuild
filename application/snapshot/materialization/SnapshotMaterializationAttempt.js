...
//
// application/snapshot/placement/SnapshotPlacementResolutionObservation.js (0.8.20) names the
...
//
// `source.kind` — one of application/snapshot/materialization/SnapshotMaterializationSourceKind.js's
// three values, naming WHICH explicit action produced this attempt.
// `outcome` — one of application/snapshot/materialization/StoreSnapshotContentOutcome.js's three
...
// application/placement/LocalPlacementKnowledgeStore.js entry, a convergence result,
// a replica synchronization, or an application/publication/replica/PublicationReplicaPackage.js
