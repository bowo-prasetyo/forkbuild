import { SnapshotPlacementResolutionOutcome } from '../placement/SnapshotPlacementResolutionOutcome.js';
import { SnapshotPlacementMaterializationOutcome } from '../placement/SnapshotPlacementMaterializationOutcome.js';
...
// runs through the SAME application/snapshot/materialization/StoreSnapshotContentUseCase.js
// application/snapshot/ImportPublicationSnapshotTransferPackageUseCase.js (0.8.32)
...
// 0.8.20's own application/snapshot/placement/SnapshotPlacementResolutionCoordinator.js
...
// application/snapshot/materialization/StoreSnapshotContentUseCase.js means that boundary verifies
...
// (application/placement/LocalPlacementKnowledgeStore.js), or resolution history
// (application/snapshot/placement/SnapshotPlacementResolutionObservation.js) — exactly as
// application/snapshot/ImportPublicationSnapshotTransferPackageUseCase.js's own
...
export class MaterializeSnapshotFromPlacementUseCase {
    ...
    // discovered (application/snapshot/placement/SnapshotPlacementResolutionCoordinator.js#
