...
//
//   application/snapshot/WorldSnapshotComparison.js's own descriptor (0.9.181)
//        │  { aPublicationId, bPublicationId, samePublication,
//        │    contentComparison }
//        │
//        │  application/snapshot/materialization/WorldSnapshotContentView.js's own descriptor
//        │  (0.9.183) — one for "Publication A," one for "Publication B"
//        │  { publicationId, contentHash, material, position }  × 2
//        ▼
//   application/snapshot/materialization/WorldSnapshotContentComparisonView.js   ★ (THIS milestone)
...
//   verbatim from `application/snapshot/WorldSnapshotComparison.js`.** Inherited
...
//           genuinely available for the Publication the comparison names)
//
// `comparisonResult` — `application/snapshot/WorldSnapshotComparison.js`'s own
...
//                        returns `null`.
// `contentViewA`/`contentViewB` — each `application/snapshot/materialization/WorldSnapshotContentView.js`'s
