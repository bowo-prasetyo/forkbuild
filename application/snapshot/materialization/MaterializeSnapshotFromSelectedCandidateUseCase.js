...
// application/snapshot/materialization/MaterializeSnapshotFromPlacementUseCase.js (0.8.35) already
...
// (application/snapshot/materialization/StoreSnapshotContentUseCase.js). This class never
...
// reason }` (application/snapshot/DecentralizedSnapshotResolver.js#resolveCandidate(),
// 0.9.152, equivalently application/snapshot/ResolveSelectedSnapshotCommand.js's own
...
// establish validity") and application/snapshot/SnapshotPublicationAttribution.js's
...
// application/nostr/NostrSnapshotDiscoveryQueryService.js or content/
// ArweaveContentStore.js.
//
// NON-RESOLVED OUTCOMES ARE REPORTED VERBATIM, NEVER REMAPPED — THE
// IDENTICAL RESTRAINT application/snapshot/SnapshotPublicationAttribution.js's OWN
...
// never imports application/snapshot/SnapshotPublicationAttribution.js, never
...
// storage }`, application/snapshot/DecentralizedSnapshotResolver.js's own shape)
...
//   business logic.** application/snapshot/materialization/MaterializeSelectedSnapshotCommand.js is
//   a plain assembly boundary over this class, exactly mirroring
//   application/snapshot/ResolveSelectedSnapshotCommand.js one seam over.
...
export class MaterializeSnapshotFromSelectedCandidateUseCase {
    ...
    // application/snapshot/materialization/MaterializeSnapshotFromPeerUseCase.js are already wired
    ...
    //                        application/snapshot/DecentralizedSnapshotResolutionOutcome.js's
