...
//
// Names every way application/snapshot/materialization/StoreSnapshotContentUseCase.js#execute() can
...
//                         application/snapshot/materialization/SnapshotContentTransferOutcome.js's
...
// its own UI. `application/snapshot/materialization/SnapshotContentTransferOutcome.js` and
// `application/snapshot/placement/SnapshotPlacementMaterializationOutcome.js` each keep their
...
// happened to them? See application/snapshot/materialization/StoreSnapshotContentUseCase.js's own
// header.
