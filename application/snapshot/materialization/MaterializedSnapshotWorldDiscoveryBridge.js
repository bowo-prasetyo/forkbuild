...
import { SnapshotWorldRegistrationOutcome } from '../placement/SnapshotWorldRegistrationOutcome.js';
...
// `application/discovery/WorldDiscoverySourceRegistry.js` (0.9.9) already answers
...
//
//   selectedSnapshotWorldPlacementResult   (application/snapshot/placement/SnapshotWorldPlacement.js,
...
// "local" SLOT. `application/discovery/WorldDiscoveryRuntimeBootstrap.js`'s own
...
// exactly the restraint `application/snapshot/placement/SnapshotWorldPlacement.js`'s own
...
//   already-named gap (`application/discovery/WorldDiscoveryRuntimeBootstrap.js`,
...
//   `application/discovery/WorldDiscoverySourceRegistry.js` itself.
...
//
// `registry`             — an application/discovery/WorldDiscoverySourceRegistry.js
