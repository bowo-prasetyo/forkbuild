...
//
// application/snapshot/materialization/MaterializeSnapshotFromPlacementUseCase.js (0.8.35) turns an
...
// application/snapshot/materialization/StoreSnapshotContentUseCase.js. This class is its
...
// application/snapshot/materialization/PublicationSnapshotContentPeerExchange.js's own
...
// bytes application/snapshot/materialization/PublicationSnapshotContentPeerExchange.js#
...
// application/snapshot/materialization/StoreSnapshotContentUseCase.js, which recomputes the hash of
...
// restraint application/snapshot/materialization/MaterializeSnapshotFromPlacementUseCase.js's own
...
export class MaterializeSnapshotFromPeerUseCase {
    ...
    // application/snapshot/ImportPublicationSnapshotTransferPackageUseCase.js and
    // application/snapshot/materialization/MaterializeSnapshotFromPlacementUseCase.js are already
    // wired against, never a second, disconnected one.
    // publicationCatalog: an application/publication/LocalPublicationCatalog.js
...
// Same default as application/peer/PeerContentRetrievalCoordinator.js's own
