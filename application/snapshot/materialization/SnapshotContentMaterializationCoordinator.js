...
//
// application/snapshot/placement/SnapshotPlacementResolutionCoordinator.js (0.8.20) sequences
// "what's known" (discover) and "does it hold up" (resolve) for a
// placement claim; application/snapshot/placement/SnapshotPlacementCreationCoordinator.js
// (0.8.25) and application/anchoring/PublicationAnchorCreationCoordinator.js (0.8.11)
...
// pipeline application/snapshot/ImportPublicationSnapshotTransferPackageUseCase.js
...
// application/snapshot/ImportPublicationSnapshotTransferPackageUseCase.js since
...
export class SnapshotContentMaterializationCoordinator {
    ...
    // application/snapshot/materialization/SnapshotContentMaterializationView.js's own header.
    async import(pkg) {
    ...
    // Package application/snapshot/BuildPublicationSnapshotTransferPackageUseCase.js
