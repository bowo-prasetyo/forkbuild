import { WorldEncounterMaterialLoadStatus } from '../../worldEncounter/WorldEncounterMaterialLoading.js';
...
//        │
//        │  application/worldEncounter/WorldEncounterMaterialInspection.js's own
//        │  ALREADY-COMPUTED result (0.9.39, unmodified)
//        │        { selection, lead, loading, verification }
//        ▼
//   application/snapshot/materialization/WorldSnapshotContentView.js   ★ (THIS milestone)
...
// domain object `application/worldEncounter/LocalWorldEncounterMaterialSource.js` already
...
// `application/snapshot/WorldSnapshotComparison.js`'s own header insists
...
//
// `inspection`         — `application/snapshot/WorldSnapshotInspection.js`'s own
...
// `materialInspection`  — `application/worldEncounter/WorldEncounterMaterialInspection.js`'s
