...
// application/peer/PeerContentProtocol.js's own REQUEST/RESPONSE shape (0.7.4),
// narrowed and re-scoped for a DIFFERENT caller. 0.7.4's own protocol
// exists to let application/publication/PublicationResolutionCoordinator.js (0.7.5/
...
// application/snapshot/materialization/PublicationSnapshotContentPeerExchange.js's own header for
...
// application/peer/PeerContentProtocol.js's own `isValidContentHash()` and
...
// application/snapshot/placement/PublicationSnapshotPlacementPeerProtocol.js's own header
