...
//
// Names every way application/snapshot/materialization/MaterializeSnapshotFromSelectedCandidateUseCase.js
// #execute() can end for an ALREADY-RESOLVED candidate — the same "one
// enum, one file" shape application/snapshot/placement/SnapshotPlacementMaterializationOutcome.js
// (0.8.35) and application/snapshot/materialization/PeerSnapshotMaterializationOutcome.js (0.8.37)
...
// answered yet. application/snapshot/materialization/MaterializeSnapshotFromSelectedCandidateUseCase.js
// is handed something categorically different: an ALREADY-COMPLETED
// application/snapshot/DecentralizedSnapshotResolver.js#resolveCandidate() result
...
// application/snapshot/SnapshotPublicationAttribution.js's own
...
export const SnapshotCandidateMaterializationOutcome = Object.freeze({
    ...
    // yet application/snapshot/materialization/StoreSnapshotContentUseCase.js's own independent
    ...
    // happen (see application/snapshot/materialization/MaterializeSnapshotFromSelectedCandidateUseCase.js's
