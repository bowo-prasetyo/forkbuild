...
//
// application/snapshot/materialization/SnapshotMaterializationSourceKind.js (0.8.36) already names
...
// same restraint application/snapshot/materialization/MaterializeSnapshotFromPlacementUseCase.js
// and application/snapshot/materialization/MaterializeSnapshotFromPeerUseCase.js's own headers
...
// (0.8.42)."
//
// NEVER PERSISTED, exactly like application/snapshot/materialization/SnapshotMaterializationAttempt.js
// (0.8.36) one layer downstream — a selection lives only as long as the one
// `application/snapshot/materialization/SnapshotMaterializationSelectionCoordinator.js#materialize()`
