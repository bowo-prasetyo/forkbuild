...
// never accepts an application/snapshot/placement/SnapshotPlacementStoreRegistry.js, never
// consults a placement's own `storage`/`locator`, and never calls
// application/snapshot/placement/SnapshotPlacementResolver.js — checking "do I already have
...
// application/publication/evidence/PublicationEvidenceCoordinator.js#verify(anchor): every
// caller of this class already holds the publication in hand (it came
// from application/publication/LocalPublicationCatalog.js#list()/get() in the first
