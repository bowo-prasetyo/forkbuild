...
// application/publication/replica/BuildPublicationReplicaPackageUseCase.js's own "smallest
...
export class BuildPublicationSnapshotTransferPackageUseCase {
    ...
    // (application/snapshot/PublicationSnapshotTransferPackage.js's own shape).
