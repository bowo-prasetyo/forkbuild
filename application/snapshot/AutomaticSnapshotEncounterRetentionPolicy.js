...
// `application/snapshot/materialization/MaterializedSnapshotWorldDiscoveryBridge.js`. It reads
...
// `application/snapshot/ShouldRefreshSnapshotDiscovery.js` ALREADY ESTABLISHED,
...
//   never calls `application/snapshot/materialization/MaterializedSnapshotWorldDiscoveryBridge.js#
//   unregisterMaterializedSnapshotWorldSource()`, never touches
//   `application/discovery/WorldDiscoverySourceRegistry.js`, and is never invoked
//   from `application/snapshot/AutomaticSnapshotEncounterCascade.js`. Connecting
...
//   `claimedPosition` (`application/snapshot/placement/SnapshotWorldPositionClaim.js`,
