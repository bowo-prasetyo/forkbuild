...
//
// `application/snapshot/DiscoverSnapshotCommand.js` (0.9.142) is the application
...
// (0.9.152, `application/snapshot/DecentralizedSnapshotResolver.js`) instead. This
...
//        ▼
//   application/snapshot/ResolveSelectedSnapshotCommand.js   ★ (THIS)
//        executeResolveSelectedSnapshotCommand({ candidate, resolver, ... })
//        │
//        ▼
//   resolver.resolveCandidate(candidate, { contentStore, storeRegistry })
//        (application/snapshot/DecentralizedSnapshotResolver.js, 0.9.152, unmodified)
//        │
//        ▼
...
// DISTINCTION `application/snapshot/DiscoverSnapshotCommand.js`'s OWN HEADER
...
// see `application/snapshot/DecentralizedSnapshotResolver.js`'s own header, "0.9.152
...
//   later, unscheduled seam (see `application/snapshot/SnapshotPublicationAttribution.js`).
